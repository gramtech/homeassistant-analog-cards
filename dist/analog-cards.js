...
`;const Et="analog-barometer-card",St="analog-barometer-card-editor",Ct={classic:"#333333",silver:"#222222",dark:"#e8e8e8",light:"#333333","led-backlit":"#ff4d4d",fluorescent:"#baff29",futuristic:"#ff2fd0"},Pt={startAngle:-135,sweepAngle:270},Ut=[{key:"stormy",label:"Stormy",from:950,to:980,color:"#8b1a1a"},{key:"rain",label:"Rain",from:980,to:1e3,color:"#b5651d"},{key:"change",label:"Change",from:1e3,to:1015,color:"#c9a227"},{key:"fair",label:"Fair",from:1015,to:1030,color:"#4a7a3c"},{key:"v-dry",label:"Very Dry",from:1030,to:1050,color:"#2f5f4f"}],zt={hPa:{major:10,minor:2},inHg:{major:.5,minor:.1}},Mt=33.8639,Ot=new Set(["inhg","inHg","in"]),Dt=new Set(["hpa","mbar","mb"]);function Tt(t){return t/Mt}function Ht(t,e){return"inHg"===e?Tt(t):t}function jt(t,e,i){return e===i?t:Ht(function(t,e){return"inHg"===e?t*Mt:t}(t,e),i)}function Nt(t,e){const i=t.states[e]?.attributes?.unit_of_measurement;if(!i)return"hPa";const s=i.toLowerCase();return Ot.has(s)||s.includes("inhg")?"inHg":(Dt.has(s),"hPa")}const Rt=100;function Lt(t){const{min:e,max:i,unit:s,value:r,pastValue:n,needleColor:o}=t;return B`
  ...
  `}const Ft=[{name:"entity",selector:{entity:{domain:"sensor"}}},yt("name"),vt("unit",[{value:"auto",label:"Auto-detect"},{value:"hPa",label:"hPa"},{value:"inHg",label:"inHg"}]),kt("trend_hours",{min:1,max:12,step:1}),kt("trend_threshold",{min:0,step:.1}),vt("face_style",[{value:"classic",label:"Classic"},{value:"silver",label:"Silver"},{value:"dark",label:"Dark"},{value:"light",label:"Light"},{value:"led-backlit",label:"LED Backlit"},{value:"fluorescent",label:"Fluorescent"},{value:"futuristic",label:"Futuristic"}]),yt("needle_color")];const It=(Vt={entity:"Pressure sensor entity",name:"Name (optional)",unit:"Display unit",trend_hours:"Trend lookback (hours)",trend_threshold:"Trend threshold",face_style:"Face style",needle_color:"Needle color (optional, overrides face style default)"},t=>Vt[t.name]??t.name);var Vt;let qt=class extends lt{setConfig(t){this._config=t}render(){return this.hass&&this._config?q`
    ...
    `],t([ft({attribute:!1})],Kt.prototype,"hass",void 0),t([gt()],Kt.prototype,"_config",void 0),t([gt()],Kt.prototype,"_trendDirection",void 0),t([gt()],Kt.prototype,"_pastValueDisplay",void 0),Kt=t([ht(Et)],Kt),Gt={type:Et,name:"Analog Barometer",description:"A classic analog-style barometer with pressure trend tracking."},window.customCards=window.customCards||[],window.customCards.push(Gt),"function"==typeof SuppressedError&&SuppressedError;
/**
 * @license
 * Copyright 2019 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
...
`;const ki="analog-thermometer-radial-card",vi="analog-thermometer-radial-card-editor",Ai={classic:"#333333",silver:"#222222",dark:"#e8e8e8",light:"#333333","led-backlit":"#ff4d4d",fluorescent:"#baff29",futuristic:"#ff2fd0"},wi={startAngle:-135,sweepAngle:270},xi=[{key:"freezing",label:"Freezing",from:-20,to:0,color:"#2471a3"},{key:"cold",label:"Cold",from:0,to:15,color:"#5dade2"},{key:"comfortable",label:"Comfortable",from:15,to:25,color:"#4a7a3c"},{key:"warm",label:"Warm",from:25,to:32,color:"#c9a227"},{key:"hot",label:"Hot",from:32,to:45,color:"#b5651d"}],Ei={"°C":{major:10,minor:2},"°F":{major:20,minor:5}};function Si(t){return 9*t/5+32}function Ci(t,e){return"°F"===e?Si(t):t}function Pi(t,e,i){return e===i?t:Ci(function(t,e){return"°F"===e?function(t){return 5*(t-32)/9}(t):t}(t,e),i)}function Ui(t,e){const i=t.states[e]?.attributes?.unit_of_measurement;return i&&i.toLowerCase().includes("f")?"°F":"°C"}const zi=100;function Mi(t){const{min:e,max:i,unit:s,value:r,pastValue:n,needleColor:o}=t;return Le`
  ...
  `}</defs>
      <circle cx=${zi} cy=${zi} r="97" class="bezel" />
      <circle cx=${zi} cy=${zi} r="90" class="face" />
      ${function(t,e,i){return xi.map(s=>{const r=Ci(s.from,i),n=Ci(s.to,i);if(n<=t||r>=e)return Le``;const o=gi(r,t,e,wi),a=gi(n,t,e,wi);if(a<=o)return Le``;const l=fi(zi,zi,86,o,a);return Le`<path
      d=${l}
      stroke=${s.color}
      stroke-width=${9}
      fill="none"
    />`})}(e,i,s)}
      ${function(t,e,i){const{major:s,minor:r}=Ei[i];return function(t,e,i,s,r){return function(t,e,i,s){if(i<=0||s<=0||e<=t)return[];const r=[],n=s/1e3;for(let o=t;o<=e+n;o+=s){const t=Math.round(o/s)*s,e=Math.abs(t/i-Math.round(t/i))<n;r.push({value:t,major:e})}return r}(t,e,i,s).map(i=>({...i,angle:gi(i.value,t,e,r)}))}(t,e,s,r,wi).map(t=>{const e=t.major?8:4,i=di(zi,zi,72-e,t.angle),s=di(zi,zi,72,t.angle),r=Le`<line
      x1=${i.x} y1=${i.y} x2=${s.x} y2=${s.y}
      class=${t.major?"tick tick-major":"tick tick-minor"}
    />`;if(!t.major)return r;const n=di(zi,zi,50,t.angle),o=Le`<text x=${n.x} y=${n.y} class="tick-label" text-anchor="middle" dominant-baseline="middle">${Math.round(10*t.value)/10}</text>`;return Le`${r}${o}`})}(e,i,s)}
      ${function(t,e,i){return xi.map(s=>{const r=Math.max(Ci(s.from,i),t),n=Math.min(Ci(s.to,i),e);if(n<=r)return Le``;const o=gi(r,t,e,wi),a=gi(n,t,e,wi),l=`zone-label-path-${s.key}`,c=fi(zi,zi,77,o,a);return Le`
      <path id=${l} d=${c} fill="none" stroke="none" />
      <text class="zone-label" dominant-baseline="middle">
        <textPath href=${"#"+l} startOffset="50%" text-anchor="middle">${s.label}</textPath>
      </text>
    `})}(e,i,s)}
      ${function(t,e,i){if(null===t)return Le``;const s=gi(t,e,i,wi),r=di(zi,zi,88,s),n=di(zi,zi,95,s);return Le`<line
    x1=${r.x} y1=${r.y} x2=${n.x} y2=${n.y}
    class="trend-marker"
  />`}(n,e,i)}
      ${function(t,e,i,s){if(null===t)return Le``;const r=gi(t,e,i,wi);return Le`<g class="needle" transform="rotate(${r} ${zi} ${zi})">
    <polygon
      points="${zi},${38} ${97},${114} ${103},${114}"
      fill=${s}
    />
  </g>`}(r,e,i,o)}
      <circle cx=${zi} cy=${zi} r="6" class="hub" />
    </svg>
  `}const Oi=[{name:"entity",selector:{entity:{domain:"sensor"}}},pi("name"),$i("unit",[{value:"auto",label:"Auto-detect"},{value:"°C",label:"°C"},{value:"°F",label:"°F"}]),bi("trend_hours",{min:1,max:12,step:1}),bi("trend_threshold",{min:0,step:.1}),$i("face_style",[{value:"classic",label:"Classic"},{value:"silver",label:"Silver"},{value:"dark",label:"Dark"},{value:"light",label:"Light"},{value:"led-backlit",label:"LED Backlit"},{value:"fluorescent",label:"Fluorescent"},{value:"futuristic",label:"Futuristic"}]),pi("needle_color")];const Di=(Ti={entity:"Temperature sensor entity",name:"Name (optional)",unit:"Display unit",trend_hours:"Trend lookback (hours)",trend_threshold:"Trend threshold",face_style:"Face style",needle_color:"Needle color (optional, overrides face style default)"},t=>Ti[t.name]??t.name);var Ti;let Hi=class extends si{setConfig(t){this._config=t}render(){return this.hass&&this._config?Re`
    ...
    `:Re``}_valueChanged(t){!function(t,e,i={},s={}){const r=new CustomEvent(e,{bubbles:s.bubbles??!0,cancelable:s.cancelable??!1,composed:s.composed??!0,detail:i});t.dispatchEvent(r)}(this,"config-changed",{config:t.detail.value})}};Jt([li({attribute:!1})],Hi.prototype,"hass",void 0),Jt([ci()],Hi.prototype,"_config",void 0),Hi=Jt([ni(vi)],Hi);const ji={rising:"↑",falling:"↓",steady:"→",unknown:""},Ni={rising:"Rising",falling:"Falling",steady:"Steady",unknown:""};let Ri=class extends si{constructor(){super(...arguments),this._trendDirection="unknown",this._pastValueDisplay=null,this._tracker=new _i("analog-thermometer-radial-card-trend-",Pi,3e5),this._lastEntityUpdate=null}setConfig(t){if(!t.entity)throw new Error("You must specify a temperature sensor entity.");this._config=t}getCardSize(){return 4}static getConfigElement(){return document.createElement(vi)}static getStubConfig(t){const e=Object.values(t?.states??{}).find(t=>t.entity_id.startsWith("sensor.")&&"temperature"===t.attributes.device_class);return{type:"custom:analog-thermometer-radial-card",entity:e?.entity_id??""}}willUpdate(t){t.has("hass")&&this._maybeUpdateTrend()}_maybeUpdateTrend(){if(!this.hass||!this._config?.entity)return;const t=this.hass.states[this._config.entity];if(!t)return;const e=parseFloat(t.state);if(!Number.isFinite(e))return;const i=Ui(this.hass,this._config.entity),s=this._config.unit??i,r=Pi(e,i,s),n=this._config.trend_hours??3,o=this._config.trend_threshold??("°F"===s?1.8:1);if(this._lastEntityUpdate===t.last_updated)return;this._lastEntityUpdate=t.last_updated;const a=this._tracker.update(this.hass,this._config.entity,r,i,s,n,o,t=>{this._trendDirection=t.direction,this._pastValueDisplay=t.pastValueDisplay});this._trendDirection=a?.direction??"unknown",this._pastValueDisplay=a?.pastValueDisplay??null}render(){if(!this._config||!this.hass)return Re``;const t=this.hass.states[this._config.entity];if(!t)return Re`<ha-card>
      ...
      <ha-card>
        <div class=${ui({"card-content":!0,[`style-${c}`]:!0})}>
          <div class="title">${u}</div>
          ${Mi({min:a,max:l,unit:i,value:n,pastValue:this._pastValueDisplay,needleColor:h})}
          <div class="readout">
            <span class="value">${r?n.toFixed(1):"--"}</span>
            <span class="unit">${i}</span>
          </div>
    ...
    `],Jt([li({attribute:!1})],Ri.prototype,"hass",void 0),Jt([ci()],Ri.prototype,"_config",void 0),Jt([ci()],Ri.prototype,"_trendDirection",void 0),Jt([ci()],Ri.prototype,"_pastValueDisplay",void 0),Ri=Jt([ni(ki)],Ri),Li={type:ki,name:"Analog Thermometer (Radial)",description:"A classic analog-style radial thermometer dial with temperature trend tracking."},window.customCards=window.customCards||[],window.customCards.push(Li),"function"==typeof SuppressedError&&SuppressedError;
/**
 * @license
 * Copyright 2019 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
...
`,ur="analog-thermometer-mercury-card",dr="analog-thermometer-mercury-card-editor",fr={classic:"#c0392b",silver:"#c9cdd1",dark:"#e05c4d",light:"#c0392b","led-backlit":"#ff4d4d",fluorescent:"#baff29",futuristic:"#ff2fd0"},gr={"°C":{major:10,minor:2},"°F":{major:20,minor:5}};function pr(t){const{min:e,max:i,unit:s,value:r,pastValue:n,liquidColor:o}=t;return Ms`
  ...
  `}</defs>
      ...
      ${function(t,e,i){const{major:s,minor:r}=gr[i];return function(t,e,i,s,r,n){return function(t,e,i,s){if(i<=0||s<=0||e<=t)return[];const r=[],n=s/1e3;for(let o=t;o<=e+n;o+=s){const t=Math.round(o/s)*s,e=Math.abs(t/i-Math.round(t/i))<n;r.push({value:t,major:e})}return r}(t,e,i,s).map(i=>({...i,position:rr(i.value,t,e,r,n)}))}(t,e,s,r,185,16).map(t=>{const e=t.major?8:4,i=Ms`<line
      x1=${74} y1=${t.position} x2=${74+e} y2=${t.position}
      class=${t.major?"tick tick-major":"tick tick-minor"}
    />`;if(!t.major)return i;const s=Ms`<text x=${86} y=${t.position} class="tick-label" dominant-baseline="middle">${Math.round(10*t.value)/10}</text>`;return Ms`${i}${s}`})}(e,i,s)}
      ${function(t,e,i){if(null===t)return Ms``;const s=rr(t,e,i,185,16);return Ms`<line
    x1=${40} y1=${s} x2=${46} y2=${s}
    class="trend-marker"
  />`}(n,e,i)}
      ${function(t,e,i,s){if(null===t)return Ms``;const r=rr(t,e,i,185,16),n=Math.max(0,193-r);return Ms`
    <rect
      x=${53}
      y=${r}
      width=${14}
      ...
      fill=${s}
    />
    <circle cx=${60} cy=${205} r=${20} class="bulb" fill=${s} />
  `}(r,e,i,o)}
      <rect
        x=${48}
        y=${16}
        ...
        class="glass"
      />
      <circle cx=${60} cy=${205} r=${23} class="glass-bulb-ring" />
      <ellipse cx=${55} cy=${199} rx="4" ry="7" class="bulb-highlight" />
    </svg>
  `}function br(t){return 9*t/5+32}function $r(t,e,i){return e===i?t:(s=function(t,e){return"°F"===e?function(t){return 5*(t-32)/9}(t):t}(t,e),"°F"===i?br(s):s);var s}function mr(t,e){const i=t.states[e]?.attributes?.unit_of_measurement;return i&&i.toLowerCase().includes("f")?"°F":"°C"}const _r=[{name:"entity",selector:{entity:{domain:"sensor"}}},nr("name"),ar("unit",[{value:"auto",label:"Auto-detect"},{value:"°C",label:"°C"},{value:"°F",label:"°F"}]),or("trend_hours",{min:1,max:12,step:1}),or("trend_threshold",{min:0,step:.1}),ar("face_style",[{value:"classic",label:"Classic"},{value:"silver",label:"Silver"},{value:"dark",label:"Dark"},{value:"light",label:"Light"},{value:"led-backlit",label:"LED Backlit"},{value:"fluorescent",label:"Fluorescent"},{value:"futuristic",label:"Futuristic"}]),nr("liquid_color")];const yr=(kr={entity:"Temperature sensor entity",name:"Name (optional)",unit:"Display unit",trend_hours:"Trend lookback (hours)",trend_threshold:"Trend threshold",face_style:"Face style",liquid_color:"Liquid color (optional, overrides face style default)"},t=>kr[t.name]??t.name);var kr;let vr=class extends Js{setConfig(t){this._config=t}render(){return this.hass&&this._config?zs`
      <ha-form
        .hass=${this.hass}
        .data=${this._config}
        .schema=${_r}
        ...
        @value-changed=${this._valueChanged}
      ></ha-form>
    `:zs``}_valueChanged(t){!function(t,e,i={},s={}){const r=new CustomEvent(e,{bubbles:s.bubbles??!0,cancelable:s.cancelable??!1,composed:s.composed??!0,detail:i});t.dispatchEvent(r)}(this,"config-changed",{config:t.detail.value})}};Fi([tr({attribute:!1})],vr.prototype,"hass",void 0),Fi([er()],vr.prototype,"_config",void 0),vr=Fi([Ys(dr)],vr);const Ar={rising:"↑",falling:"↓",steady:"→",unknown:""},wr={rising:"Rising",falling:"Falling",steady:"Steady",unknown:""};let xr=class extends Js{constructor(){super(...arguments),this._trendDirection="unknown",this._pastValueDisplay=null,this._tracker=new cr("analog-thermometer-mercury-card-trend-",$r,3e5),this._lastEntityUpdate=null}setConfig(t){if(!t.entity)throw new Error("You must specify a temperature sensor entity.");this._config=t}getCardSize(){return 4}static getConfigElement(){return document.createElement(dr)}static getStubConfig(t){const e=Object.values(t?.states??{}).find(t=>t.entity_id.startsWith("sensor.")&&"temperature"===t.attributes.device_class);return{type:"custom:analog-thermometer-mercury-card",entity:e?.entity_id??""}}willUpdate(t){t.has("hass")&&this._maybeUpdateTrend()}_maybeUpdateTrend(){if(!this.hass||!this._config?.entity)return;const t=this.hass.states[this._config.entity];if(!t)return;const e=parseFloat(t.state);if(!Number.isFinite(e))return;const i=mr(this.hass,this._config.entity),s=this._config.unit??i,r=$r(e,i,s),n=this._config.trend_hours??3,o=this._config.trend_threshold??("°F"===s?1.8:1);if(this._lastEntityUpdate===t.last_updated)return;this._lastEntityUpdate=t.last_updated;const a=this._tracker.update(this.hass,this._config.entity,r,i,s,n,o,t=>{this._trendDirection=t.direction,this._pastValueDisplay=t.pastValueDisplay});this._trendDirection=a?.direction??"unknown",this._pastValueDisplay=a?.pastValueDisplay??null}render(){if(!this._config||!this.hass)return zs``;const t=this.hass.states[this._config.entity];if(!t)return zs`<ha-card>
        <div class="warning">Entity not found: ${this._config.entity}</div>
      </ha-card>`;const e=mr(this.hass,this._config.entity),i=this._config.unit??e,s=parseFloat(t.state),r=Number.isFinite(s),n=r?$r(s,e,i):null,o="°F"===i?{min:br(-20),max:br(45)}:{min:-20,max:45},a=this._config.min??o.min,l=this._config.max??o.max,c=this._config.face_style??"classic",h=this._config.liquid_color||fr[c],u=this._config.name??t.attributes.friendly_name??this._config.entity;return zs`
      <ha-card>
        <div class=${sr({"card-content":!0,[`style-${c}`]:!0})}>
          <div class="title">${u}</div>
          ${pr({min:a,max:l,unit:i,value:n,pastValue:this._pastValueDisplay,liquidColor:h})}
          <div class="readout">
            <span class="value">${r?n.toFixed(1):"--"}</span>
            <span class="unit">${i}</span>
          </div>
          <div class="trend trend-${this._trendDirection}">
            <span class="arrow">${Ar[this._trendDirection]}</span>
            <span class="label">${wr[this._trendDirection]}</span>
          </div>
        </div>
      </ha-card>
    `}};var Er;function Sr(t,e,i,s){var r,n=arguments.length,o=n<3?e:s;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)o=Reflect.decorate(t,e,i,s);else for(var a=t.length-1;a>=0;a--)(r=t[a])&&(o=(n<3?r(o):n>3?r(e,i,o):r(e,i))||o);return n>3&&o&&Object.defineProperty(e,i,o),o}xr.styles=[hr,Ki`
      :host {
        display: block;
      }
      .card-content {
    ...
    `],Fi([tr({attribute:!1})],xr.prototype,"hass",void 0),Fi([er()],xr.prototype,"_config",void 0),Fi([er()],xr.prototype,"_trendDirection",void 0),Fi([er()],xr.prototype,"_pastValueDisplay",void 0),xr=Fi([Ys(ur)],xr),Er={type:ur,name:"Analog Thermometer (Mercury)",description:"A classic mercury-tube style thermometer with temperature trend tracking."},window.customCards=window.customCards||[],window.customCards.push(Er),"function"==typeof SuppressedError&&SuppressedError;
/**
 * @license
 * Copyright 2019 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */
const Cr=globalThis,Pr=Cr.ShadowRoot&&(void 0===Cr.ShadyCSS||Cr.ShadyCSS.nativeShadow)&&"adoptedStyleSheets"in Document.prototype&&"replace"in CSSStyleSheet.prototype,Ur=Symbol(),zr=new WeakMap;let Mr=class{constructor(t,e,i){if(this._$cssResult$=!0,i!==Ur)throw Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");this.cssText=t,this.t=e}get styleSheet(){let t=this.o;const e=this.t;if(Pr&&void 0===t){const i=void 0!==e&&1===e.length;i&&(t=zr.get(e)),void 0===t&&((this.o=t=new CSSStyleSheet).replaceSync(this.cssText),i&&zr.set(e,t))}return t}toString(){return this.cssText}};const Or=(t,...e)=>{const i=1===t.length?t[0]:e.reduce((e,i,s)=>e+(t=>{if(!0===t._$cssResult$)return t.cssText;if("number"==typeof t)return t;throw Error("Value passed to 'css' function must be a 'css' function result: "+t+". Use 'unsafeCSS' to pass non-literal values, but take care to ensure page security.")})(i)+t[s+1],t[0]);return new Mr(i,t,Ur)},Dr=Pr?t=>t:t=>t instanceof CSSStyleSheet?(t=>{let e="";for(const i of t.cssRules)e+=i.cssText;return(t=>new Mr("string"==typeof t?t:t+"",void 0,Ur))(e)})(t):t,{is:Tr,defineProperty:Hr,getOwnPropertyDescriptor:jr,getOwnPropertyNames:Nr,getOwnPropertySymbols:Rr,getPrototypeOf:Lr}=Object,Fr=globalThis,Ir=Fr.trustedTypes,Vr=Ir?Ir.emptyScript:"",qr=Fr.reactiveElementPolyfillSupport,Br=(t,e)=>t,Wr={toAttribute(t,e){switch(e){case Boolean:t=t?Vr:null;break;case Object:case Array:t=null==t?t:JSON.stringify(t)}return t},fromAttribute(t,e){let i=t;switch(e){case Boolean:i=null!==t;break;case Number:i=null===t?null:Number(t);break;case Object:case Array:try{i=JSON.parse(t)}catch(t){i=null}}return i}},Kr=(t,e)=>!Tr(t,e),Gr={attribute:!0,type:String,converter:Wr,reflect:!1,useDefault:!1,hasChanged:Kr};
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */Symbol.metadata??=Symbol("metadata"),Fr.litPropertyMetadata??=new WeakMap;let Jr=class extends HTMLElement{static addInitializer(t){this._$Ei(),(this.l??=[]).push(t)}static get observedAttributes(){return this.finalize(),this._$Eh&&[...this._$Eh.keys()]}static createProperty(t,e=Gr){if(e.state&&(e.attribute=!1),this._$Ei(),this.prototype.hasOwnProperty(t)&&((e=Object.create(e)).wrapped=!0),this.elementProperties.set(t,e),!e.noAccessor){const i=Symbol(),s=this.getPropertyDescriptor(t,i,e);void 0!==s&&Hr(this.prototype,t,s)}}static getPropertyDescriptor(t,e,i){const{get:s,set:r}=jr(this.prototype,t)??{get(){return this[e]},set(t){this[e]=t}};return{get:s,set(e){const n=s?.call(this);r?.call(this,e),this.requestUpdate(t,n,i)},configurable:!0,enumerable:!0}}static getPropertyOptions(t){return this.elementProperties.get(t)??Gr}static _$Ei(){if(this.hasOwnProperty(Br("elementProperties")))return;const t=Lr(this);t.finalize(),void 0!==t.l&&(this.l=[...t.l]),this.elementProperties=new Map(t.elementProperties)}static finalize(){if(this.hasOwnProperty(Br("finalized")))return;if(this.finalized=!0,this._$Ei(),this.hasOwnProperty(Br("properties"))){const t=this.properties,e=[...Nr(t),...Rr(t)];for(const i of e)this.createProperty(i,t[i])}const t=this[Symbol.metadata];if(null!==t){const e=litPropertyMetadata.get(t);if(void 0!==e)for(const[t,i]of e)this.elementProperties.set(t,i)}this._$Eh=new Map;for(const[t,e]of this.elementProperties){const i=this._$Eu(t,e);void 0!==i&&this._$Eh.set(i,t)}this.elementStyles=this.finalizeStyles(this.styles)}static finalizeStyles(t){const e=[];if(Array.isArray(t)){const i=new Set(t.flat(1/0).reverse());for(const t of i)e.unshift(Dr(t))}else void 0!==t&&e.push(Dr(t));return e}static _$Eu(t,e){const i=e.attribute;return!1===i?void 0:"string"==typeof i?i:"string"==typeof t?t.toLowerCase():void 0}constructor(){super(),this._$Ep=void 0,this.isUpdatePending=!1,this.hasUpdated=!1,this._$Em=null,this._$Ev()}_$Ev(){this._$ES=new Promise(t=>this.enableUpdating=t),this._$AL=new Map,this._$E_(),this.requestUpdate(),this.constructor.l?.forEach(t=>t(this))}addController(t){(this._$EO??=new Set).add(t),void 0!==this.renderRoot&&this.isConnected&&t.hostConnected?.()}removeController(t){this._$EO?.delete(t)}_$E_(){const t=new Map,e=this.constructor.elementProperties;for(const i of e.keys())this.hasOwnProperty(i)&&(t.set(i,this[i]),delete this[i]);t.size>0&&(this._$Ep=t)}createRenderRoot(){const t=this.shadowRoot??this.attachShadow(this.constructor.shadowRootOptions);return((t,e)=>{if(Pr)t.adoptedStyleSheets=e.map(t=>t instanceof CSSStyleSheet?t:t.styleSheet);else for(const i of e){const e=document.createElement("style"),s=Cr.litNonce;void 0!==s&&e.setAttribute("nonce",s),e.textContent=i.cssText,t.appendChild(e)}})(t,this.constructor.elementStyles),t}connectedCallback(){this.renderRoot??=this.createRenderRoot(),this.enableUpdating(!0),this._$EO?.forEach(t=>t.hostConnected?.())}enableUpdating(t){}disconnectedCallback(){this._$EO?.forEach(t=>t.hostDisconnected?.())}attributeChangedCallback(t,e,i){this._$AK(t,i)}_$ET(t,e){const i=this.constructor.elementProperties.get(t),s=this.constructor._$Eu(t,i);if(void 0!==s&&!0===i.reflect){const r=(void 0!==i.converter?.toAttribute?i.converter:Wr).toAttribute(e,i.type);this._$Em=t,null==r?this.removeAttribute(s):this.setAttribute(s,r),this._$Em=null}}_$AK(t,e){const i=this.constructor,s=i._$Eh.get(t);if(void 0!==s&&this._$Em!==s){const t=i.getPropertyOptions(s),r="function"==typeof t.converter?{fromAttribute:t.converter}:void 0!==t.converter?.fromAttribute?t.converter:Wr;this._$Em=s;const n=r.fromAttribute(e,t.type);this[s]=n??this._$Ej?.get(s)??n,this._$Em=null}}requestUpdate(t,e,i,s=!1,r){if(void 0!==t){const n=this.constructor;if(!1===s&&(r=this[t]),i??=n.getPropertyOptions(t),!((i.hasChanged??Kr)(r,e)||i.useDefault&&i.reflect&&r===this._$Ej?.get(t)&&!this.hasAttribute(n._$Eu(t,i))))return;this.C(t,e,i)}!1===this.isUpdatePending&&(this._$ES=this._$EP())}C(t,e,{useDefault:i,reflect:s,wrapped:r},n){i&&!(this._$Ej??=new Map).has(t)&&(this._$Ej.set(t,n??e??this[t]),!0!==r||void 0!==n)||(this._$AL.has(t)||(this.hasUpdated||i||(e=void 0),this._$AL.set(t,e)),!0===s&&this._$Em!==t&&(this._$Eq??=new Set).add(t))}async _$EP(){this.isUpdatePending=!0;try{await this._$ES}catch(t){Promise.reject(t)}const t=this.scheduleUpdate();return null!=t&&await t,!this.isUpdatePending}scheduleUpdate(){return this.performUpdate()}performUpdate(){if(!this.isUpdatePending)return;if(!this.hasUpdated){if(this.renderRoot??=this.createRenderRoot(),this._$Ep){for(const[t,e]of this._$Ep)this[t]=e;this._$Ep=void 0}const t=this.constructor.elementProperties;if(t.size>0)for(const[e,i]of t){const{wrapped:t}=i,s=this[e];!0!==t||this._$AL.has(e)||void 0===s||this.C(e,void 0,i,s)}}let t=!1;const e=this._$AL;try{t=this.shouldUpdate(e),t?(this.willUpdate(e),this._$EO?.forEach(t=>t.hostUpdate?.()),this.update(e)):this._$EM()}catch(e){throw t=!1,this._$EM(),e}t&&this._$AE(e)}willUpdate(t){}_$AE(t){this._$EO?.forEach(t=>t.hostUpdated?.()),this.hasUpdated||(this.hasUpdated=!0,this.firstUpdated(t)),this.updated(t)}_$EM(){this._$AL=new Map,this.isUpdatePending=!1}get updateComplete(){return this.getUpdateComplete()}getUpdateComplete(){return this._$ES}shouldUpdate(t){return!0}update(t){this._$Eq&&=this._$Eq.forEach(t=>this._$ET(t,this[t])),this._$EM()}updated(t){}firstUpdated(t){}};Jr.elementStyles=[],Jr.shadowRootOptions={mode:"open"},Jr[Br("elementProperties")]=new Map,Jr[Br("finalized")]=new Map,qr?.({ReactiveElement:Jr}),(Fr.reactiveElementVersions??=[]).push("2.1.2");
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */
const Zr=globalThis,Yr=t=>t,Qr=Zr.trustedTypes,Xr=Qr?Qr.createPolicy("lit-html",{createHTML:t=>t}):void 0,tn="$lit$",en=`lit$${Math.random().toFixed(9).slice(2)}$`,sn="?"+en,rn=`<${sn}>`,nn=document,on=()=>nn.createComment(""),an=t=>null===t||"object"!=typeof t&&"function"!=typeof t,ln=Array.isArray,cn="[ \t\n\f\r]",hn=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,un=/-->/g,dn=/>/g,fn=RegExp(`>|${cn}(?:([^\\s"'>=/]+)(${cn}*=${cn}*(?:[^ \t\n\f\r"'\`<>=]|("|')|))|$)`,"g"),gn=/'/g,pn=/"/g,bn=/^(?:script|style|textarea|title)$/i,$n=t=>(e,...i)=>({_$litType$:t,strings:e,values:i}),mn=$n(1),_n=$n(2),yn=Symbol.for("lit-noChange"),kn=Symbol.for("lit-nothing"),vn=new WeakMap,An=nn.createTreeWalker(nn,129);function wn(t,e){if(!ln(t)||!t.hasOwnProperty("raw"))throw Error("invalid template strings array");return void 0!==Xr?Xr.createHTML(e):e}let xn=class t{constructor({strings:e,_$litType$:i},s){let r;this.parts=[];let n=0,o=0;const a=e.length-1,l=this.parts,[c,h]=((t,e)=>{const i=t.length-1,s=[];let r,n=2===e?"<svg>":3===e?"<math>":"",o=hn;for(let e=0;e<i;e++){const i=t[e];let a,l,c=-1,h=0;for(;h<i.length&&(o.lastIndex=h,l=o.exec(i),null!==l);)h=o.lastIndex,o===hn?"!--"===l[1]?o=un:void 0!==l[1]?o=dn:void 0!==l[2]?(bn.test(l[2])&&(r=RegExp("</"+l[2],"g")),o=fn):void 0!==l[3]&&(o=fn):o===fn?">"===l[0]?(o=r??hn,c=-1):void 0===l[1]?c=-2:(c=o.lastIndex-l[2].length,a=l[1],o=void 0===l[3]?fn:'"'===l[3]?pn:gn):o===pn||o===gn?o=fn:o===un||o===dn?o=hn:(o=fn,r=void 0);const u=o===fn&&t[e+1].startsWith("/>")?" ":"";n+=o===hn?i+rn:c>=0?(s.push(a),i.slice(0,c)+tn+i.slice(c)+en+u):i+en+(-2===c?e:u)}return[wn(t,n+(t[i]||"<?>")+(2===e?"</svg>":3===e?"</math>":"")),s]})(e,i);if(this.el=t.createElement(c,s),An.currentNode=this.el.content,2===i||3===i){const t=this.el.content.firstChild;t.replaceWith(...t.childNodes)}for(;null!==(r=An.nextNode())&&l.length<a;){if(1===r.nodeType){if(r.hasAttributes())for(const t of r.getAttributeNames())if(t.endsWith(tn)){const e=h[o++],i=r.getAttribute(t).split(en),s=/([.?@])?(.*)/.exec(e);l.push({type:1,index:n,name:s[2],strings:i,ctor:"."===s[1]?Un:"?"===s[1]?zn:"@"===s[1]?Mn:Pn}),r.removeAttribute(t)}else t.startsWith(en)&&(l.push({type:6,index:n}),r.removeAttribute(t));if(bn.test(r.tagName)){const t=r.textContent.split(en),e=t.length-1;if(e>0){r.textContent=Qr?Qr.emptyScript:"";for(let i=0;i<e;i++)r.append(t[i],on()),An.nextNode(),l.push({type:2,index:++n});r.append(t[e],on())}}}else if(8===r.nodeType)if(r.data===sn)l.push({type:2,index:n});else{let t=-1;for(;-1!==(t=r.data.indexOf(en,t+1));)l.push({type:7,index:n}),t+=en.length-1}n++}}static createElement(t,e){const i=nn.createElement("template");return i.innerHTML=t,i}};function En(t,e,i=t,s){if(e===yn)return e;let r=void 0!==s?i._$Co?.[s]:i._$Cl;const n=an(e)?void 0:e._$litDirective$;return r?.constructor!==n&&(r?._$AO?.(!1),void 0===n?r=void 0:(r=new n(t),r._$AT(t,i,s)),void 0!==s?(i._$Co??=[])[s]=r:i._$Cl=r),void 0!==r&&(e=En(t,r._$AS(t,e.values),r,s)),e}class Sn{constructor(t,e){this._$AV=[],this._$AN=void 0,this._$AD=t,this._$AM=e}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(t){const{el:{content:e},parts:i}=this._$AD,s=(t?.creationScope??nn).importNode(e,!0);An.currentNode=s;let r=An.nextNode(),n=0,o=0,a=i[0];for(;void 0!==a;){if(n===a.index){let e;2===a.type?e=new Cn(r,r.nextSibling,this,t):1===a.type?e=new a.ctor(r,a.name,a.strings,this,t):6===a.type&&(e=new On(r,this,t)),this._$AV.push(e),a=i[++o]}n!==a?.index&&(r=An.nextNode(),n++)}return An.currentNode=nn,s}p(t){let e=0;for(const i of this._$AV)void 0!==i&&(void 0!==i.strings?(i._$AI(t,i,e),e+=i.strings.length-2):i._$AI(t[e])),e++}}class Cn{get _$AU(){return this._$AM?._$AU??this._$Cv}constructor(t,e,i,s){this.type=2,this._$AH=kn,this._$AN=void 0,this._$AA=t,this._$AB=e,this._$AM=i,this.options=s,this._$Cv=s?.isConnected??!0}get parentNode(){let t=this._$AA.parentNode;const e=this._$AM;return void 0!==e&&11===t?.nodeType&&(t=e.parentNode),t}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(t,e=this){t=En(this,t,e),an(t)?t===kn||null==t||""===t?(this._$AH!==kn&&this._$AR(),this._$AH=kn):t!==this._$AH&&t!==yn&&this._(t):void 0!==t._$litType$?this.$(t):void 0!==t.nodeType?this.T(t):(t=>ln(t)||"function"==typeof t?.[Symbol.iterator])(t)?this.k(t):this._(t)}O(t){return this._$AA.parentNode.insertBefore(t,this._$AB)}T(t){this._$AH!==t&&(this._$AR(),this._$AH=this.O(t))}_(t){this._$AH!==kn&&an(this._$AH)?this._$AA.nextSibling.data=t:this.T(nn.createTextNode(t)),this._$AH=t}$(t){const{values:e,_$litType$:i}=t,s="number"==typeof i?this._$AC(t):(void 0===i.el&&(i.el=xn.createElement(wn(i.h,i.h[0]),this.options)),i);if(this._$AH?._$AD===s)this._$AH.p(e);else{const t=new Sn(s,this),i=t.u(this.options);t.p(e),this.T(i),this._$AH=t}}_$AC(t){let e=vn.get(t.strings);return void 0===e&&vn.set(t.strings,e=new xn(t)),e}k(t){ln(this._$AH)||(this._$AH=[],this._$AR());const e=this._$AH;let i,s=0;for(const r of t)s===e.length?e.push(i=new Cn(this.O(on()),this.O(on()),this,this.options)):i=e[s],i._$AI(r),s++;s<e.length&&(this._$AR(i&&i._$AB.nextSibling,s),e.length=s)}_$AR(t=this._$AA.nextSibling,e){for(this._$AP?.(!1,!0,e);t!==this._$AB;){const e=Yr(t).nextSibling;Yr(t).remove(),t=e}}setConnected(t){void 0===this._$AM&&(this._$Cv=t,this._$AP?.(t))}}class Pn{get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}constructor(t,e,i,s,r){this.type=1,this._$AH=kn,this._$AN=void 0,this.element=t,this.name=e,this._$AM=s,this.options=r,i.length>2||""!==i[0]||""!==i[1]?(this._$AH=Array(i.length-1).fill(new String),this.strings=i):this._$AH=kn}_$AI(t,e=this,i,s){const r=this.strings;let n=!1;if(void 0===r)t=En(this,t,e,0),n=!an(t)||t!==this._$AH&&t!==yn,n&&(this._$AH=t);else{const s=t;let o,a;for(t=r[0],o=0;o<r.length-1;o++)a=En(this,s[i+o],e,o),a===yn&&(a=this._$AH[o]),n||=!an(a)||a!==this._$AH[o],a===kn?t=kn:t!==kn&&(t+=(a??"")+r[o+1]),this._$AH[o]=a}n&&!s&&this.j(t)}j(t){t===kn?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,t??"")}}class Un extends Pn{constructor(){super(...arguments),this.type=3}j(t){this.element[this.name]=t===kn?void 0:t}}class zn extends Pn{constructor(){super(...arguments),this.type=4}j(t){this.element.toggleAttribute(this.name,!!t&&t!==kn)}}class Mn extends Pn{constructor(t,e,i,s,r){super(t,e,i,s,r),this.type=5}_$AI(t,e=this){if((t=En(this,t,e,0)??kn)===yn)return;const i=this._$AH,s=t===kn&&i!==kn||t.capture!==i.capture||t.once!==i.once||t.passive!==i.passive,r=t!==kn&&(i===kn||s);s&&this.element.removeEventListener(this.name,this,i),r&&this.element.addEventListener(this.name,this,t),this._$AH=t}handleEvent(t){"function"==typeof this._$AH?this._$AH.call(this.options?.host??this.element,t):this._$AH.handleEvent(t)}}class On{constructor(t,e,i){this.element=t,this.type=6,this._$AN=void 0,this._$AM=e,this.options=i}get _$AU(){return this._$AM._$AU}_$AI(t){En(this,t)}}const Dn=Zr.litHtmlPolyfillSupport;Dn?.(xn,Cn),(Zr.litHtmlVersions??=[]).push("3.3.3");const Tn=globalThis;
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */let Hn=class extends Jr{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){const t=super.createRenderRoot();return this.renderOptions.renderBefore??=t.firstChild,t}update(t){const e=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(t),this._$Do=((t,e,i)=>{const s=i?.renderBefore??e;let r=s._$litPart$;if(void 0===r){const t=i?.renderBefore??null;s._$litPart$=r=new Cn(e.insertBefore(on(),t),t,void 0,i??{})}return r._$AI(t),r})(e,this.renderRoot,this.renderOptions)}connectedCallback(){super.connectedCallback(),this._$Do?.setConnected(!0)}disconnectedCallback(){super.disconnectedCallback(),this._$Do?.setConnected(!1)}render(){return yn}};Hn._$litElement$=!0,Hn.finalized=!0,Tn.litElementHydrateSupport?.({LitElement:Hn});const jn=Tn.litElementPolyfillSupport;jn?.({LitElement:Hn}),(Tn.litElementVersions??=[]).push("4.2.2");
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */
const Nn=t=>(e,i)=>{void 0!==i?i.addInitializer(()=>{customElements.define(t,e)}):customElements.define(t,e)},Rn={attribute:!0,type:String,converter:Wr,reflect:!1,hasChanged:Kr},Ln=(t=Rn,e,i)=>{const{kind:s,metadata:r}=i;let n=globalThis.litPropertyMetadata.get(r);if(void 0===n&&globalThis.litPropertyMetadata.set(r,n=new Map),"setter"===s&&((t=Object.create(t)).wrapped=!0),n.set(i.name,t),"accessor"===s){const{name:s}=i;return{set(i){const r=e.get.call(this);e.set.call(this,i),this.requestUpdate(s,r,t,!0,i)},init(e){return void 0!==e&&this.C(s,void 0,t,e),e}}}if("setter"===s){const{name:s}=i;return function(i){const r=this[s];e.call(this,i),this.requestUpdate(s,r,t,!0,i)}}throw Error("Unsupported decorator location: "+s)};
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function Fn(t){return(e,i)=>"object"==typeof i?Ln(t,e,i):((t,e,i)=>{const s=e.hasOwnProperty(i);return e.constructor.createProperty(i,t),s?Object.getOwnPropertyDescriptor(e,i):void 0})(t,e,i)}
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function In(t){return Fn({...t,state:!0,attribute:!1})}
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */class Vn{constructor(t){}get _$AU(){return this._$AM._$AU}_$AT(t,e,i){this._$Ct=t,this._$AM=e,this._$Ci=i}_$AS(t,e){return this.update(t,e)}update(t,e){return this.render(...e)}}
/**
 * @license
 * Copyright 2018 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const qn=(t=>(...e)=>({_$litDirective$:t,values:e}))(class extends Vn{constructor(t){if(super(t),1!==t.type||"class"!==t.name||t.strings?.length>2)throw Error("`classMap()` can only be used in the `class` attribute and must be the only part in the attribute.")}render(t){return" "+Object.keys(t).filter(e=>t[e]).join(" ")+" "}update(t,[e]){if(void 0===this.st){this.st=new Set,void 0!==t.strings&&(this.nt=new Set(t.strings.join(" ").split(/\s/).filter(t=>""!==t)));for(const t in e)e[t]&&!this.nt?.has(t)&&this.st.add(t);return this.render(e)}const i=t.element.classList;for(const t of this.st)t in e||(i.remove(t),this.st.delete(t));for(const t in e){const s=!!e[t];s===this.st.has(t)||this.nt?.has(t)||(s?(i.add(t),this.st.add(t)):(i.remove(t),this.st.delete(t)))}return yn}});function Bn(t,e,i,s){const r=(s-90)*Math.PI/180;return{x:t+i*Math.cos(r),y:e+i*Math.sin(r)}}function Wn(t,e,i,s,r){const n=Bn(t,e,i,s),o=Bn(t,e,i,r),a=r-s<=180?0:1;return`M ${n.x} ${n.y} A ${i} ${i} 0 ${a} 1 ${o.x} ${o.y}`}function Kn(t,e,i,s){if(i<=e)return s.startAngle;let r;if(s.wrap){const s=i-e;r=((t-e)%s+s)%s/s}else r=(Math.min(i,Math.max(e,t))-e)/(i-e);return s.startAngle+r*s.sweepAngle}function Gn(t){return{name:t,selector:{text:{}}}}function Jn(t,e){return{name:t,selector:{number:{...e,mode:"box"}}}}function Zn(t,e,i){const s=t-e;return Math.abs(s)<i?"steady":s>0?"rising":"falling"}class Yn{constructor(t,e,i=3e5){this.storageKeyPrefix=t,this.convert=e,this.throttleMs=i,this.cache=null,this.cachedEntityId=null,this.inFlight=null}storageKey(t){return`${this.storageKeyPrefix}${t}`}getCached(t){return this.cachedEntityId!==t&&(this.cachedEntityId=t,this.cache=function(t){try{const e=localStorage.getItem(t);return e?JSON.parse(e):null}catch{return null}}(this.storageKey(t))),this.cache}shouldFetch(t){const e=this.getCached(t);return!e||Date.now()-e.fetchedAt>this.throttleMs}update(t,e,i,s,r,n,o,a){const l=this.getCached(e);return this.inFlight||!this.shouldFetch(e)||(this.inFlight=async function(t,e,i){const s=`history/period/${new Date(Date.now()-36e5*i).toISOString()}?filter_entity_id=${encodeURIComponent(e)}&minimal_response&no_attributes`,r=await t.callApi("GET",s),n=r?.[0];if(!n?.length)return null;const o=n[0],a=o.state??o.s;if(void 0===a)return null;const l=parseFloat(a);return Number.isFinite(l)?l:null}(t,e,n).then(t=>{if(null===t)return{direction:"unknown",pastValueDisplay:null,fetchedAt:Date.now()};const e=this.convert(t,s,r);return{direction:Zn(i,e,o),pastValueDisplay:e,fetchedAt:Date.now()}}).catch(()=>({direction:l?.direction??"unknown",pastValueDisplay:l?.pastValueDisplay??null,fetchedAt:Date.now()})).then(t=>(this.cache=t,function(t,e){try{localStorage.setItem(t,JSON.stringify(e))}catch{}}(this.storageKey(e),t),this.inFlight=null,a?.(t),t))),l}}const Qn=Or`
  .style-classic {
    --gauge-bezel-fill: #cfc3a5;
    --gauge-bezel-stroke: #7a6a45;
    --gauge-face-fill: #f2e9d0;
...
`;const Xn="analog-humidity-radial-card",to="analog-humidity-radial-card-editor",eo={classic:"#333333",silver:"#222222",dark:"#e8e8e8",light:"#333333","led-backlit":"#ff4d4d",fluorescent:"#baff29",futuristic:"#ff2fd0"},io={startAngle:-135,sweepAngle:270},so=[{key:"dry",label:"Dry",from:0,to:30,color:"#b5651d"},{key:"comfortable",label:"Comfortable",from:30,to:50,color:"#4a7a3c"},{key:"humid",label:"Humid",from:50,to:70,color:"#c9a227"},{key:"very-humid",label:"Very Humid",from:70,to:100,color:"#2471a3"}],ro={major:10,minor:2},no=100;function oo(t){const{min:e,max:i,value:s,pastValue:r,needleColor:n}=t;return _n`
  ...
  `}</defs>
      <circle cx=${no} cy=${no} r="97" class="bezel" />
      <circle cx=${no} cy=${no} r="90" class="face" />
      ${function(t,e){return so.map(i=>{if(i.to<=t||i.from>=e)return _n``;const s=Kn(i.from,t,e,io),r=Kn(i.to,t,e,io);if(r<=s)return _n``;const n=Wn(no,no,86,s,r);return _n`<path
      d=${n}
      stroke=${i.color}
      stroke-width=${9}
      fill="none"
    />`})}(e,i)}
      ${function(t,e){const{major:i,minor:s}=ro;return function(t,e,i,s,r){return function(t,e,i,s){if(e<=t)return[];const r=[],n=s/1e3;for(let o=t;o<=e+n;o+=s){const t=Math.round(o/s)*s,e=Math.abs(t/i-Math.round(t/i))<n;r.push({value:t,major:e})}return r}(t,e,i,s).map(i=>({...i,angle:Kn(i.value,t,e,r)}))}(t,e,i,s,io).map(t=>{const e=t.major?8:4,i=Bn(no,no,72-e,t.angle),s=Bn(no,no,72,t.angle),r=_n`<line
      x1=${i.x} y1=${i.y} x2=${s.x} y2=${s.y}
      class=${t.major?"tick tick-major":"tick tick-minor"}
    />`;if(!t.major)return r;const n=Bn(no,no,50,t.angle),o=_n`<text x=${n.x} y=${n.y} class="tick-label" text-anchor="middle" dominant-baseline="middle">${Math.round(10*t.value)/10}</text>`;return _n`${r}${o}`})}(e,i)}
      ${function(t,e){return so.map(i=>{const s=Math.max(i.from,t),r=Math.min(i.to,e);if(r<=s)return _n``;const n=Kn(s,t,e,io),o=Kn(r,t,e,io),a=`zone-label-path-${i.key}`,l=Wn(no,no,77,n,o);return _n`
      <path id=${a} d=${l} fill="none" stroke="none" />
      <text class="zone-label" dominant-baseline="middle">
        <textPath href=${"#"+a} startOffset="50%" text-anchor="middle">${i.label}</textPath>
      </text>
    `})}(e,i)}
      ${function(t,e,i){if(null===t)return _n``;const s=Kn(t,e,i,io),r=Bn(no,no,88,s),n=Bn(no,no,95,s);return _n`<line
    x1=${r.x} y1=${r.y} x2=${n.x} y2=${n.y}
    class="trend-marker"
  />`}(r,e,i)}
      ${function(t,e,i,s){if(null===t)return _n``;const r=Kn(t,e,i,io);return _n`<g class="needle" transform="rotate(${r} ${no} ${no})">
    <polygon
      points="${no},${38} ${97},${114} ${103},${114}"
      fill=${s}
    />
  </g>`}(s,e,i,n)}
      <circle cx=${no} cy=${no} r="6" class="hub" />
    </svg>
  `}function ao(t,e,i){return t}const lo=[{name:"entity",selector:{entity:{domain:"sensor"}}},Gn("name"),Jn("trend_hours",{min:1,max:12,step:1}),Jn("trend_threshold",{min:0,step:.5}),{name:"face_style",selector:{select:{mode:"dropdown",options:[{value:"classic",label:"Classic"},{value:"silver",label:"Silver"},{value:"dark",label:"Dark"},{value:"light",label:"Light"},{value:"led-backlit",label:"LED Backlit"},{value:"fluorescent",label:"Fluorescent"},{value:"futuristic",label:"Futuristic"}]}}},Gn("needle_color")];const co=(ho={entity:"Humidity sensor entity",name:"Name (optional)",trend_hours:"Trend lookback (hours)",trend_threshold:"Trend threshold",face_style:"Face style",needle_color:"Needle color (optional, overrides face style default)"},t=>ho[t.name]??t.name);var ho;let uo=class extends Hn{setConfig(t){this._config=t}render(){return this.hass&&this._config?mn`
      <ha-form
        .hass=${this.hass}
        .data=${this._config}
        .schema=${lo}
        ...
        @value-changed=${this._valueChanged}
      ></ha-form>
    `:mn``}_valueChanged(t){!function(t,e,i={},s={}){const r=new CustomEvent(e,{bubbles:s.bubbles??!0,cancelable:s.cancelable??!1,composed:s.composed??!0,detail:i});t.dispatchEvent(r)}(this,"config-changed",{config:t.detail.value})}};Sr([Fn({attribute:!1})],uo.prototype,"hass",void 0),Sr([In()],uo.prototype,"_config",void 0),uo=Sr([Nn(to)],uo);const fo={rising:"↑",falling:"↓",steady:"→",unknown:""},go={rising:"Rising",falling:"Falling",steady:"Steady",unknown:""};let po=class extends Hn{constructor(){super(...arguments),this._trendDirection="unknown",this._pastValueDisplay=null,this._tracker=new Yn("analog-humidity-radial-card-trend-",ao,3e5),this._lastEntityUpdate=null}setConfig(t){if(!t.entity)throw new Error("You must specify a humidity sensor entity.");this._config=t}getCardSize(){return 4}static getConfigElement(){return document.createElement(to)}static getStubConfig(t){const e=Object.values(t?.states??{}).find(t=>t.entity_id.startsWith("sensor.")&&"humidity"===t.attributes.device_class);return{type:"custom:analog-humidity-radial-card",entity:e?.entity_id??""}}willUpdate(t){t.has("hass")&&this._maybeUpdateTrend()}_maybeUpdateTrend(){if(!this.hass||!this._config?.entity)return;const t=this.hass.states[this._config.entity];if(!t)return;const e=parseFloat(t.state);if(!Number.isFinite(e))return;const i=(this.hass,this._config.entity,"%"),s=ao(e),r=this._config.trend_hours??3,n=this._config.trend_threshold??3;if(this._lastEntityUpdate===t.last_updated)return;this._lastEntityUpdate=t.last_updated;const o=this._tracker.update(this.hass,this._config.entity,s,i,i,r,n,t=>{this._trendDirection=t.direction,this._pastValueDisplay=t.pastValueDisplay});this._trendDirection=o?.direction??"unknown",this._pastValueDisplay=o?.pastValueDisplay??null}render(){if(!this._config||!this.hass)return mn``;const t=this.hass.states[this._config.entity];if(!t)return mn`<ha-card>
        <div class="warning">Entity not found: ${this._config.entity}</div>
      </ha-card>`;const e=(this.hass,this._config.entity,"%"),i=parseFloat(t.state),s=Number.isFinite(i),r=s?ao(i):null,n=0,o=100,a=this._config.min??n,l=this._config.max??o,c=this._config.face_style??"classic",h=this._config.needle_color||eo[c],u=this._config.name??t.attributes.friendly_name??this._config.entity;return mn`
      <ha-card>
        <div class=${qn({"card-content":!0,[`style-${c}`]:!0})}>
          <div class="title">${u}</div>
          ${oo({min:a,max:l,value:r,pastValue:this._pastValueDisplay,needleColor:h})}
          <div class="readout">
            <span class="value">${s?r.toFixed(0):"--"}</span>
            <span class="unit">${e}</span>
          </div>
          <div class="trend trend-${this._trendDirection}">
            <span class="arrow">${fo[this._trendDirection]}</span>
            <span class="label">${go[this._trendDirection]}</span>
          </div>
        </div>
      </ha-card>
    `}};var bo;function $o(t,e,i,s){var r,n=arguments.length,o=n<3?e:s;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)o=Reflect.decorate(t,e,i,s);else for(var a=t.length-1;a>=0;a--)(r=t[a])&&(o=(n<3?r(o):n>3?r(e,i,o):r(e,i))||o);return n>3&&o&&Object.defineProperty(e,i,o),o}po.styles=[Qn,Or`
      :host {
        display: block;
      }
      .card-content {
    ...
    `],Sr([Fn({attribute:!1})],po.prototype,"hass",void 0),Sr([In()],po.prototype,"_config",void 0),Sr([In()],po.prototype,"_trendDirection",void 0),Sr([In()],po.prototype,"_pastValueDisplay",void 0),po=Sr([Nn(Xn)],po),bo={type:Xn,name:"Analog Humidity (Radial)",description:"A classic analog-style radial hygrometer dial with humidity trend tracking."},window.customCards=window.customCards||[],window.customCards.push(bo),"function"==typeof SuppressedError&&SuppressedError;
/**
 * @license
 * Copyright 2019 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */
const mo=globalThis,_o=mo.ShadowRoot&&(void 0===mo.ShadyCSS||mo.ShadyCSS.nativeShadow)&&"adoptedStyleSheets"in Document.prototype&&"replace"in CSSStyleSheet.prototype,yo=Symbol(),ko=new WeakMap;let vo=class{constructor(t,e,i){if(this._$cssResult$=!0,i!==yo)throw Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");this.cssText=t,this.t=e}get styleSheet(){let t=this.o;const e=this.t;if(_o&&void 0===t){const i=void 0!==e&&1===e.length;i&&(t=ko.get(e)),void 0===t&&((this.o=t=new CSSStyleSheet).replaceSync(this.cssText),i&&ko.set(e,t))}return t}toString(){return this.cssText}};const Ao=(t,...e)=>{const i=1===t.length?t[0]:e.reduce((e,i,s)=>e+(t=>{if(!0===t._$cssResult$)return t.cssText;if("number"==typeof t)return t;throw Error("Value passed to 'css' function must be a 'css' function result: "+t+". Use 'unsafeCSS' to pass non-literal values, but take care to ensure page security.")})(i)+t[s+1],t[0]);return new vo(i,t,yo)},wo=_o?t=>t:t=>t instanceof CSSStyleSheet?(t=>{let e="";for(const i of t.cssRules)e+=i.cssText;return(t=>new vo("string"==typeof t?t:t+"",void 0,yo))(e)})(t):t,{is:xo,defineProperty:Eo,getOwnPropertyDescriptor:So,getOwnPropertyNames:Co,getOwnPropertySymbols:Po,getPrototypeOf:Uo}=Object,zo=globalThis,Mo=zo.trustedTypes,Oo=Mo?Mo.emptyScript:"",Do=zo.reactiveElementPolyfillSupport,To=(t,e)=>t,Ho={toAttribute(t,e){switch(e){case Boolean:t=t?Oo:null;break;case Object:case Array:t=null==t?t:JSON.stringify(t)}return t},fromAttribute(t,e){let i=t;switch(e){case Boolean:i=null!==t;break;case Number:i=null===t?null:Number(t);break;case Object:case Array:try{i=JSON.parse(t)}catch(t){i=null}}return i}},jo=(t,e)=>!xo(t,e),No={attribute:!0,type:String,converter:Ho,reflect:!1,useDefault:!1,hasChanged:jo};
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */Symbol.metadata??=Symbol("metadata"),zo.litPropertyMetadata??=new WeakMap;let Ro=class extends HTMLElement{static addInitializer(t){this._$Ei(),(this.l??=[]).push(t)}static get observedAttributes(){return this.finalize(),this._$Eh&&[...this._$Eh.keys()]}static createProperty(t,e=No){if(e.state&&(e.attribute=!1),this._$Ei(),this.prototype.hasOwnProperty(t)&&((e=Object.create(e)).wrapped=!0),this.elementProperties.set(t,e),!e.noAccessor){const i=Symbol(),s=this.getPropertyDescriptor(t,i,e);void 0!==s&&Eo(this.prototype,t,s)}}static getPropertyDescriptor(t,e,i){const{get:s,set:r}=So(this.prototype,t)??{get(){return this[e]},set(t){this[e]=t}};return{get:s,set(e){const n=s?.call(this);r?.call(this,e),this.requestUpdate(t,n,i)},configurable:!0,enumerable:!0}}static getPropertyOptions(t){return this.elementProperties.get(t)??No}static _$Ei(){if(this.hasOwnProperty(To("elementProperties")))return;const t=Uo(this);t.finalize(),void 0!==t.l&&(this.l=[...t.l]),this.elementProperties=new Map(t.elementProperties)}static finalize(){if(this.hasOwnProperty(To("finalized")))return;if(this.finalized=!0,this._$Ei(),this.hasOwnProperty(To("properties"))){const t=this.properties,e=[...Co(t),...Po(t)];for(const i of e)this.createProperty(i,t[i])}const t=this[Symbol.metadata];if(null!==t){const e=litPropertyMetadata.get(t);if(void 0!==e)for(const[t,i]of e)this.elementProperties.set(t,i)}this._$Eh=new Map;for(const[t,e]of this.elementProperties){const i=this._$Eu(t,e);void 0!==i&&this._$Eh.set(i,t)}this.elementStyles=this.finalizeStyles(this.styles)}static finalizeStyles(t){const e=[];if(Array.isArray(t)){const i=new Set(t.flat(1/0).reverse());for(const t of i)e.unshift(wo(t))}else void 0!==t&&e.push(wo(t));return e}static _$Eu(t,e){const i=e.attribute;return!1===i?void 0:"string"==typeof i?i:"string"==typeof t?t.toLowerCase():void 0}constructor(){super(),this._$Ep=void 0,this.isUpdatePending=!1,this.hasUpdated=!1,this._$Em=null,this._$Ev()}_$Ev(){this._$ES=new Promise(t=>this.enableUpdating=t),this._$AL=new Map,this._$E_(),this.requestUpdate(),this.constructor.l?.forEach(t=>t(this))}addController(t){(this._$EO??=new Set).add(t),void 0!==this.renderRoot&&this.isConnected&&t.hostConnected?.()}removeController(t){this._$EO?.delete(t)}_$E_(){const t=new Map,e=this.constructor.elementProperties;for(const i of e.keys())this.hasOwnProperty(i)&&(t.set(i,this[i]),delete this[i]);t.size>0&&(this._$Ep=t)}createRenderRoot(){const t=this.shadowRoot??this.attachShadow(this.constructor.shadowRootOptions);return((t,e)=>{if(_o)t.adoptedStyleSheets=e.map(t=>t instanceof CSSStyleSheet?t:t.styleSheet);else for(const i of e){const e=document.createElement("style"),s=mo.litNonce;void 0!==s&&e.setAttribute("nonce",s),e.textContent=i.cssText,t.appendChild(e)}})(t,this.constructor.elementStyles),t}connectedCallback(){this.renderRoot??=this.createRenderRoot(),this.enableUpdating(!0),this._$EO?.forEach(t=>t.hostConnected?.())}enableUpdating(t){}disconnectedCallback(){this._$EO?.forEach(t=>t.hostDisconnected?.())}attributeChangedCallback(t,e,i){this._$AK(t,i)}_$ET(t,e){const i=this.constructor.elementProperties.get(t),s=this.constructor._$Eu(t,i);if(void 0!==s&&!0===i.reflect){const r=(void 0!==i.converter?.toAttribute?i.converter:Ho).toAttribute(e,i.type);this._$Em=t,null==r?this.removeAttribute(s):this.setAttribute(s,r),this._$Em=null}}_$AK(t,e){const i=this.constructor,s=i._$Eh.get(t);if(void 0!==s&&this._$Em!==s){const t=i.getPropertyOptions(s),r="function"==typeof t.converter?{fromAttribute:t.converter}:void 0!==t.converter?.fromAttribute?t.converter:Ho;this._$Em=s;const n=r.fromAttribute(e,t.type);this[s]=n??this._$Ej?.get(s)??n,this._$Em=null}}requestUpdate(t,e,i,s=!1,r){if(void 0!==t){const n=this.constructor;if(!1===s&&(r=this[t]),i??=n.getPropertyOptions(t),!((i.hasChanged??jo)(r,e)||i.useDefault&&i.reflect&&r===this._$Ej?.get(t)&&!this.hasAttribute(n._$Eu(t,i))))return;this.C(t,e,i)}!1===this.isUpdatePending&&(this._$ES=this._$EP())}C(t,e,{useDefault:i,reflect:s,wrapped:r},n){i&&!(this._$Ej??=new Map).has(t)&&(this._$Ej.set(t,n??e??this[t]),!0!==r||void 0!==n)||(this._$AL.has(t)||(this.hasUpdated||i||(e=void 0),this._$AL.set(t,e)),!0===s&&this._$Em!==t&&(this._$Eq??=new Set).add(t))}async _$EP(){this.isUpdatePending=!0;try{await this._$ES}catch(t){Promise.reject(t)}const t=this.scheduleUpdate();return null!=t&&await t,!this.isUpdatePending}scheduleUpdate(){return this.performUpdate()}performUpdate(){if(!this.isUpdatePending)return;if(!this.hasUpdated){if(this.renderRoot??=this.createRenderRoot(),this._$Ep){for(const[t,e]of this._$Ep)this[t]=e;this._$Ep=void 0}const t=this.constructor.elementProperties;if(t.size>0)for(const[e,i]of t){const{wrapped:t}=i,s=this[e];!0!==t||this._$AL.has(e)||void 0===s||this.C(e,void 0,i,s)}}let t=!1;const e=this._$AL;try{t=this.shouldUpdate(e),t?(this.willUpdate(e),this._$EO?.forEach(t=>t.hostUpdate?.()),this.update(e)):this._$EM()}catch(e){throw t=!1,this._$EM(),e}t&&this._$AE(e)}willUpdate(t){}_$AE(t){this._$EO?.forEach(t=>t.hostUpdated?.()),this.hasUpdated||(this.hasUpdated=!0,this.firstUpdated(t)),this.updated(t)}_$EM(){this._$AL=new Map,this.isUpdatePending=!1}get updateComplete(){return this.getUpdateComplete()}getUpdateComplete(){return this._$ES}shouldUpdate(t){return!0}update(t){this._$Eq&&=this._$Eq.forEach(t=>this._$ET(t,this[t])),this._$EM()}updated(t){}firstUpdated(t){}};Ro.elementStyles=[],Ro.shadowRootOptions={mode:"open"},Ro[To("elementProperties")]=new Map,Ro[To("finalized")]=new Map,Do?.({ReactiveElement:Ro}),(zo.reactiveElementVersions??=[]).push("2.1.2");
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */
const Lo=globalThis,Fo=t=>t,Io=Lo.trustedTypes,Vo=Io?Io.createPolicy("lit-html",{createHTML:t=>t}):void 0,qo="$lit$",Bo=`lit$${Math.random().toFixed(9).slice(2)}$`,Wo="?"+Bo,Ko=`<${Wo}>`,Go=document,Jo=()=>Go.createComment(""),Zo=t=>null===t||"object"!=typeof t&&"function"!=typeof t,Yo=Array.isArray,Qo="[ \t\n\f\r]",Xo=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,ta=/-->/g,ea=/>/g,ia=RegExp(`>|${Qo}(?:([^\\s"'>=/]+)(${Qo}*=${Qo}*(?:[^ \t\n\f\r"'\`<>=]|("|')|))|$)`,"g"),sa=/'/g,ra=/"/g,na=/^(?:script|style|textarea|title)$/i,oa=t=>(e,...i)=>({_$litType$:t,strings:e,values:i}),aa=oa(1),la=oa(2),ca=Symbol.for("lit-noChange"),ha=Symbol.for("lit-nothing"),ua=new WeakMap,da=Go.createTreeWalker(Go,129);function fa(t,e){if(!Yo(t)||!t.hasOwnProperty("raw"))throw Error("invalid template strings array");return void 0!==Vo?Vo.createHTML(e):e}class ga{constructor({strings:t,_$litType$:e},i){let s;this.parts=[];let r=0,n=0;const o=t.length-1,a=this.parts,[l,c]=((t,e)=>{const i=t.length-1,s=[];let r,n=2===e?"<svg>":3===e?"<math>":"",o=Xo;for(let e=0;e<i;e++){const i=t[e];let a,l,c=-1,h=0;for(;h<i.length&&(o.lastIndex=h,l=o.exec(i),null!==l);)h=o.lastIndex,o===Xo?"!--"===l[1]?o=ta:void 0!==l[1]?o=ea:void 0!==l[2]?(na.test(l[2])&&(r=RegExp("</"+l[2],"g")),o=ia):void 0!==l[3]&&(o=ia):o===ia?">"===l[0]?(o=r??Xo,c=-1):void 0===l[1]?c=-2:(c=o.lastIndex-l[2].length,a=l[1],o=void 0===l[3]?ia:'"'===l[3]?ra:sa):o===ra||o===sa?o=ia:o===ta||o===ea?o=Xo:(o=ia,r=void 0);const u=o===ia&&t[e+1].startsWith("/>")?" ":"";n+=o===Xo?i+Ko:c>=0?(s.push(a),i.slice(0,c)+qo+i.slice(c)+Bo+u):i+Bo+(-2===c?e:u)}return[fa(t,n+(t[i]||"<?>")+(2===e?"</svg>":3===e?"</math>":"")),s]})(t,e);if(this.el=ga.createElement(l,i),da.currentNode=this.el.content,2===e||3===e){const t=this.el.content.firstChild;t.replaceWith(...t.childNodes)}for(;null!==(s=da.nextNode())&&a.length<o;){if(1===s.nodeType){if(s.hasAttributes())for(const t of s.getAttributeNames())if(t.endsWith(qo)){const e=c[n++],i=s.getAttribute(t).split(Bo),o=/([.?@])?(.*)/.exec(e);a.push({type:1,index:r,name:o[2],strings:i,ctor:"."===o[1]?_a:"?"===o[1]?ya:"@"===o[1]?ka:ma}),s.removeAttribute(t)}else t.startsWith(Bo)&&(a.push({type:6,index:r}),s.removeAttribute(t));if(na.test(s.tagName)){const t=s.textContent.split(Bo),e=t.length-1;if(e>0){s.textContent=Io?Io.emptyScript:"";for(let i=0;i<e;i++)s.append(t[i],Jo()),da.nextNode(),a.push({type:2,index:++r});s.append(t[e],Jo())}}}else if(8===s.nodeType)if(s.data===Wo)a.push({type:2,index:r});else{let t=-1;for(;-1!==(t=s.data.indexOf(Bo,t+1));)a.push({type:7,index:r}),t+=Bo.length-1}r++}}static createElement(t,e){const i=Go.createElement("template");return i.innerHTML=t,i}}function pa(t,e,i=t,s){if(e===ca)return e;let r=void 0!==s?i._$Co?.[s]:i._$Cl;const n=Zo(e)?void 0:e._$litDirective$;return r?.constructor!==n&&(r?._$AO?.(!1),void 0===n?r=void 0:(r=new n(t),r._$AT(t,i,s)),void 0!==s?(i._$Co??=[])[s]=r:i._$Cl=r),void 0!==r&&(e=pa(t,r._$AS(t,e.values),r,s)),e}class ba{constructor(t,e){this._$AV=[],this._$AN=void 0,this._$AD=t,this._$AM=e}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(t){const{el:{content:e},parts:i}=this._$AD,s=(t?.creationScope??Go).importNode(e,!0);da.currentNode=s;let r=da.nextNode(),n=0,o=0,a=i[0];for(;void 0!==a;){if(n===a.index){let e;2===a.type?e=new $a(r,r.nextSibling,this,t):1===a.type?e=new a.ctor(r,a.name,a.strings,this,t):6===a.type&&(e=new va(r,this,t)),this._$AV.push(e),a=i[++o]}n!==a?.index&&(r=da.nextNode(),n++)}return da.currentNode=Go,s}p(t){let e=0;for(const i of this._$AV)void 0!==i&&(void 0!==i.strings?(i._$AI(t,i,e),e+=i.strings.length-2):i._$AI(t[e])),e++}}class $a{get _$AU(){return this._$AM?._$AU??this._$Cv}constructor(t,e,i,s){this.type=2,this._$AH=ha,this._$AN=void 0,this._$AA=t,this._$AB=e,this._$AM=i,this.options=s,this._$Cv=s?.isConnected??!0}get parentNode(){let t=this._$AA.parentNode;const e=this._$AM;return void 0!==e&&11===t?.nodeType&&(t=e.parentNode),t}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(t,e=this){t=pa(this,t,e),Zo(t)?t===ha||null==t||""===t?(this._$AH!==ha&&this._$AR(),this._$AH=ha):t!==this._$AH&&t!==ca&&this._(t):void 0!==t._$litType$?this.$(t):void 0!==t.nodeType?this.T(t):(t=>Yo(t)||"function"==typeof t?.[Symbol.iterator])(t)?this.k(t):this._(t)}O(t){return this._$AA.parentNode.insertBefore(t,this._$AB)}T(t){this._$AH!==t&&(this._$AR(),this._$AH=this.O(t))}_(t){this._$AH!==ha&&Zo(this._$AH)?this._$AA.nextSibling.data=t:this.T(Go.createTextNode(t)),this._$AH=t}$(t){const{values:e,_$litType$:i}=t,s="number"==typeof i?this._$AC(t):(void 0===i.el&&(i.el=ga.createElement(fa(i.h,i.h[0]),this.options)),i);if(this._$AH?._$AD===s)this._$AH.p(e);else{const t=new ba(s,this),i=t.u(this.options);t.p(e),this.T(i),this._$AH=t}}_$AC(t){let e=ua.get(t.strings);return void 0===e&&ua.set(t.strings,e=new ga(t)),e}k(t){Yo(this._$AH)||(this._$AH=[],this._$AR());const e=this._$AH;let i,s=0;for(const r of t)s===e.length?e.push(i=new $a(this.O(Jo()),this.O(Jo()),this,this.options)):i=e[s],i._$AI(r),s++;s<e.length&&(this._$AR(i&&i._$AB.nextSibling,s),e.length=s)}_$AR(t=this._$AA.nextSibling,e){for(this._$AP?.(!1,!0,e);t!==this._$AB;){const e=Fo(t).nextSibling;Fo(t).remove(),t=e}}setConnected(t){void 0===this._$AM&&(this._$Cv=t,this._$AP?.(t))}}class ma{get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}constructor(t,e,i,s,r){this.type=1,this._$AH=ha,this._$AN=void 0,this.element=t,this.name=e,this._$AM=s,this.options=r,i.length>2||""!==i[0]||""!==i[1]?(this._$AH=Array(i.length-1).fill(new String),this.strings=i):this._$AH=ha}_$AI(t,e=this,i,s){const r=this.strings;let n=!1;if(void 0===r)t=pa(this,t,e,0),n=!Zo(t)||t!==this._$AH&&t!==ca,n&&(this._$AH=t);else{const s=t;let o,a;for(t=r[0],o=0;o<r.length-1;o++)a=pa(this,s[i+o],e,o),a===ca&&(a=this._$AH[o]),n||=!Zo(a)||a!==this._$AH[o],a===ha?t=ha:t!==ha&&(t+=(a??"")+r[o+1]),this._$AH[o]=a}n&&!s&&this.j(t)}j(t){t===ha?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,t??"")}}class _a extends ma{constructor(){super(...arguments),this.type=3}j(t){this.element[this.name]=t===ha?void 0:t}}class ya extends ma{constructor(){super(...arguments),this.type=4}j(t){this.element.toggleAttribute(this.name,!!t&&t!==ha)}}class ka extends ma{constructor(t,e,i,s,r){super(t,e,i,s,r),this.type=5}_$AI(t,e=this){if((t=pa(this,t,e,0)??ha)===ca)return;const i=this._$AH,s=t===ha&&i!==ha||t.capture!==i.capture||t.once!==i.once||t.passive!==i.passive,r=t!==ha&&(i===ha||s);s&&this.element.removeEventListener(this.name,this,i),r&&this.element.addEventListener(this.name,this,t),this._$AH=t}handleEvent(t){"function"==typeof this._$AH?this._$AH.call(this.options?.host??this.element,t):this._$AH.handleEvent(t)}}class va{constructor(t,e,i){this.element=t,this.type=6,this._$AN=void 0,this._$AM=e,this.options=i}get _$AU(){return this._$AM._$AU}_$AI(t){pa(this,t)}}const Aa=Lo.litHtmlPolyfillSupport;Aa?.(ga,$a),(Lo.litHtmlVersions??=[]).push("3.3.3");const wa=globalThis;
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */let xa=class extends Ro{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){const t=super.createRenderRoot();return this.renderOptions.renderBefore??=t.firstChild,t}update(t){const e=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(t),this._$Do=((t,e,i)=>{const s=i?.renderBefore??e;let r=s._$litPart$;if(void 0===r){const t=i?.renderBefore??null;s._$litPart$=r=new $a(e.insertBefore(Jo(),t),t,void 0,i??{})}return r._$AI(t),r})(e,this.renderRoot,this.renderOptions)}connectedCallback(){super.connectedCallback(),this._$Do?.setConnected(!0)}disconnectedCallback(){super.disconnectedCallback(),this._$Do?.setConnected(!1)}render(){return ca}};xa._$litElement$=!0,xa.finalized=!0,wa.litElementHydrateSupport?.({LitElement:xa});const Ea=wa.litElementPolyfillSupport;Ea?.({LitElement:xa}),(wa.litElementVersions??=[]).push("4.2.2");
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */
const Sa=t=>(e,i)=>{void 0!==i?i.addInitializer(()=>{customElements.define(t,e)}):customElements.define(t,e)},Ca={attribute:!0,type:String,converter:Ho,reflect:!1,hasChanged:jo},Pa=(t=Ca,e,i)=>{const{kind:s,metadata:r}=i;let n=globalThis.litPropertyMetadata.get(r);if(void 0===n&&globalThis.litPropertyMetadata.set(r,n=new Map),"setter"===s&&((t=Object.create(t)).wrapped=!0),n.set(i.name,t),"accessor"===s){const{name:s}=i;return{set(i){const r=e.get.call(this);e.set.call(this,i),this.requestUpdate(s,r,t,!0,i)},init(e){return void 0!==e&&this.C(s,void 0,t,e),e}}}if("setter"===s){const{name:s}=i;return function(i){const r=this[s];e.call(this,i),this.requestUpdate(s,r,t,!0,i)}}throw Error("Unsupported decorator location: "+s)};
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function Ua(t){return(e,i)=>"object"==typeof i?Pa(t,e,i):((t,e,i)=>{const s=e.hasOwnProperty(i);return e.constructor.createProperty(i,t),s?Object.getOwnPropertyDescriptor(e,i):void 0})(t,e,i)}
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */class za{constructor(t){}get _$AU(){return this._$AM._$AU}_$AT(t,e,i){this._$Ct=t,this._$AM=e,this._$Ci=i}_$AS(t,e){return this.update(t,e)}update(t,e){return this.render(...e)}}
/**
 * @license
 * Copyright 2018 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Ma=(t=>(...e)=>({_$litDirective$:t,values:e}))(class extends za{constructor(t){if(super(t),1!==t.type||"class"!==t.name||t.strings?.length>2)throw Error("`classMap()` can only be used in the `class` attribute and must be the only part in the attribute.")}render(t){return" "+Object.keys(t).filter(e=>t[e]).join(" ")+" "}update(t,[e]){if(void 0===this.st){this.st=new Set,void 0!==t.strings&&(this.nt=new Set(t.strings.join(" ").split(/\s/).filter(t=>""!==t)));for(const t in e)e[t]&&!this.nt?.has(t)&&this.st.add(t);return this.render(e)}const i=t.element.classList;for(const t of this.st)t in e||(i.remove(t),this.st.delete(t));for(const t in e){const s=!!e[t];s===this.st.has(t)||this.nt?.has(t)||(s?(i.add(t),this.st.add(t)):(i.remove(t),this.st.delete(t)))}return ca}});function Oa(t,e,i,s){const r=(s-90)*Math.PI/180;return{x:t+i*Math.cos(r),y:e+i*Math.sin(r)}}function Da(t){return{name:t,selector:{text:{}}}}function Ta(t,e){return{name:t,selector:{select:{mode:"dropdown",options:e}}}}const Ha=Ao`
  .style-classic {
    --gauge-bezel-fill: #cfc3a5;
    --gauge-bezel-stroke: #7a6a45;
    --gauge-face-fill: #f2e9d0;
...
`;const ja="analog-clock-card",Na="analog-clock-card-editor",Ra={classic:"#333333",silver:"#222222",dark:"#e8e8e8",light:"#333333","led-backlit":"#a8ecff",fluorescent:"#d4ff7a",futuristic:"#7df9ff"},La={classic:"#c0392b",silver:"#c0392b",dark:"#ff4d4d",light:"#c0392b","led-backlit":"#ff4d4d",fluorescent:"#baff29",futuristic:"#ff2fd0"},Fa=100;function Ia(t,e,i,s,r,n){return la`<g class=${n} transform="rotate(${t} ${Fa} ${Fa})">
    <polygon
      points="${Fa},${Fa-e} ${Fa-s},${Fa+i} ${Fa+s},${Fa+i}"
      fill=${r}
    />
  </g>`}const Va=[Da("name"),Ta("face_style",[{value:"classic",label:"Classic"},{value:"silver",label:"Silver"},{value:"dark",label:"Dark"},{value:"light",label:"Light"},{value:"led-backlit",label:"LED Backlit"},{value:"fluorescent",label:"Fluorescent"},{value:"futuristic",label:"Futuristic"}]),Da("time_zone"),{name:"show_seconds",selector:{boolean:{}}},Ta("second_hand_motion",[{value:"tick",label:"Tick (once per second)"},{value:"sweep",label:"Sweep (smooth)"}])],qa=(Ba={name:"Name (optional)",face_style:"Face style",time_zone:"Time zone (optional, e.g. America/New_York — defaults to local time)",show_seconds:"Show second hand",second_hand_motion:"Second hand motion"},t=>Ba[t.name]??t.name);var Ba;let Wa=class extends xa{setConfig(t){this._config=t}render(){return this.hass&&this._config?aa`
      <ha-form
        .hass=${this.hass}
        .data=${this._config}
        .schema=${Va}
        ...
        @value-changed=${this._valueChanged}
      ></ha-form>
    `:aa``}_valueChanged(t){!function(t,e,i={},s={}){const r=new CustomEvent(e,{bubbles:s.bubbles??!0,cancelable:s.cancelable??!1,composed:s.composed??!0,detail:i});t.dispatchEvent(r)}(this,"config-changed",{config:t.detail.value})}};$o([Ua({attribute:!1})],Wa.prototype,"hass",void 0),$o([Ua({state:!0,attribute:!1})],Wa.prototype,"_config",void 0),Wa=$o([Sa(Na)],Wa);const Ka=function(t,e=1e3){return class extends t{constructor(){super(...arguments),this.now=new Date}connectedCallback(){super.connectedCallback(),this._tick(),this._intervalId=setInterval(()=>this._tick(),e)}disconnectedCallback(){super.disconnectedCallback(),void 0!==this._intervalId&&(clearInterval(this._intervalId),this._intervalId=void 0)}_tick(){this.now=new Date,this.requestUpdate()}}}(xa,200);let Ga=class extends Ka{setConfig(t){this._config=t}getCardSize(){return 4}static getConfigElement(){return document.createElement(Na)}static getStubConfig(){return{type:"custom:analog-clock-card"}}render(){if(!this._config)return aa``;const t=this._config.face_style??"classic",e=this._config.show_seconds??!0,i=this._config.second_hand_motion??"tick",s=Ra[t],r=La[t],n=function(t,e){if(!e)return t;try{return new Date(t.toLocaleString("en-US",{timeZone:e}))}catch{return t}}(this.now,this._config.time_zone);return aa`
      <ha-card>
        <div class=${Ma({"card-content":!0,[`style-${t}`]:!0})}>
          ${this._config.name?aa`<div class="title">${this._config.name}</div>`:""}
          ${function(t){const{now:e,showSeconds:i,smoothSeconds:s,handColor:r,secondHandColor:n}=t;return la`
  ...
  `}</defs>
      ...
      ${function(){const t=[];for(let e=0;e<60;e++){const i=6*e,s=e%5==0,r=Oa(Fa,Fa,90-(s?8:4),i),n=Oa(Fa,Fa,90,i);t.push(la`<line
      x1=${r.x} y1=${r.y} x2=${n.x} y2=${n.y}
      class=${s?"tick tick-major":"tick tick-minor"}
    />`)}return t}()}
      ${function(){const t=[];for(let e=1;e<=12;e++){const i=Oa(Fa,Fa,74,30*e);t.push(la`<text x=${i.x} y=${i.y} class="numeral" text-anchor="middle" dominant-baseline="middle">${e}</text>`)}return t}()}
      ${Ia((l=e,(l.getHours()%12+l.getMinutes()/60+l.getSeconds()/3600)/12*360),45,10,4,r,"hand hour-hand")}
      ${Ia(function(t,e=!0){const i=e?t.getSeconds():0;return(t.getMinutes()+i/60)/60*360}(e),68,12,3,r,"hand minute-hand")}
      ${i?(o=function(t,e=!0){const i=e?t.getMilliseconds():0;return(t.getSeconds()+i/1e3)/60*360}(e,s),a=n,la`<g class="hand second-hand" transform="rotate(${o} ${Fa} ${Fa})">
    <line x1=${Fa} y1=${118} x2=${Fa} y2=${22} stroke=${a} />
  </g>`):la``}
  ...
  `;var o,a,l}({now:n,showSeconds:e,smoothSeconds:"sweep"===i,handColor:s,secondHandColor:r})}
    ...
    `],$o([Ua({attribute:!1})],Ga.prototype,"hass",void 0),Ga=$o([Sa(ja)],Ga),Ja={type:ja,name:"Analog Clock",description:"A classic analog clock face with hour, minute, and second hands."},window.customCards=window.customCards||[],window.customCards.push(Ja);
