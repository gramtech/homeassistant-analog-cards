...
`;const Dt="analog-barometer-card",Ot="analog-barometer-card-editor",Ht="classic",Tt={classic:"#333333",silver:"#222222",dark:"#e8e8e8",light:"#333333","led-backlit":"#ff4d4d",fluorescent:"#baff29",futuristic:"#ff2fd0"},jt={startAngle:-135,sweepAngle:270},Nt=[{key:"stormy",label:"Stormy",from:950,to:980,color:"#8b1a1a"},{key:"rain",label:"Rain",from:980,to:1e3,color:"#b5651d"},{key:"change",label:"Change",from:1e3,to:1015,color:"#c9a227"},{key:"fair",label:"Fair",from:1015,to:1030,color:"#4a7a3c"},{key:"v-dry",label:"Very Dry",from:1030,to:1050,color:"#2f5f4f"}],Rt={hPa:{major:10,minor:2},inHg:{major:.5,minor:.1}},Lt=33.8639,Ft=new Set(["inhg","inHg","in"]),It=new Set(["hpa","mbar","mb"]);function Vt(t){return t/Lt}function Bt(t,e){return"inHg"===e?Vt(t):t}function qt(t,e){return"inHg"===e?t*Lt:t}function Wt(t,e,i){return e===i?t:Bt(qt(t,e),i)}function Kt(t,e){return t&&"auto"!==t?t:e}function Gt(t,e){const i=t.states[e]?.attributes?.unit_of_measurement;if(!i)return"hPa";const s=i.toLowerCase();return Ft.has(s)||s.includes("inhg")?"inHg":(It.has(s),"hPa")}function Jt(t){return"inHg"===t?Vt(1.5):1.5}const Zt=100;function Yt(t){const{min:e,max:i,unit:s,value:r,pastValue:n,needleColor:a}=t;return q`
  ...
  `}</defs>
      <circle cx=${Zt} cy=${Zt} r="97" class="bezel" />
      <circle cx=${Zt} cy=${Zt} r="90" class="face" />
      ${function(t,e,i){return Nt.map(s=>{const r=Bt(s.from,i),n=Bt(s.to,i);if(n<=t||r>=e)return q``;const a=kt(r,t,e,jt),o=kt(n,t,e,jt);if(o<=a)return q``;const l=yt(Zt,Zt,86,a,o);return q`<path
      d=${l}
      stroke=${s.color}
      stroke-width=${9}
      fill="none"
    />`})}(e,i,s)}
      ${function(t,e,i){const{major:s,minor:r}=Rt[i];return vt(t,e,s,r,jt).map(t=>{const e=t.major?8:4,i=_t(Zt,Zt,72-e,t.angle),s=_t(Zt,Zt,72,t.angle),r=q`<line
      x1=${i.x} y1=${i.y} x2=${s.x} y2=${s.y}
      class=${t.major?"tick tick-major":"tick tick-minor"}
    />`;if(!t.major)return r;const n=_t(Zt,Zt,50,t.angle),a=q`<text x=${n.x} y=${n.y} class="tick-label" text-anchor="middle" dominant-baseline="middle">${Math.round(10*t.value)/10}</text>`;return q`${r}${a}`})}(e,i,s)}
      ${function(t,e,i){return Nt.map(s=>{const r=Math.max(Bt(s.from,i),t),n=Math.min(Bt(s.to,i),e);if(n<=r)return q``;const a=kt(r,t,e,jt),o=kt(n,t,e,jt),l=`zone-label-path-${s.key}`,c=yt(Zt,Zt,77,a,o);return q`
    ...
    `})}(e,i,s)}
      ${function(t,e,i){if(null===t)return q``;const s=kt(t,e,i,jt),r=_t(Zt,Zt,88,s),n=_t(Zt,Zt,95,s);return q`<line
    x1=${r.x} y1=${r.y} x2=${n.x} y2=${n.y}
    class="trend-marker"
  />`}(n,e,i)}
      ${function(t,e,i,s){if(null===t)return q``;const r=kt(t,e,i,jt);return q`<g class="needle" transform="rotate(${r} ${Zt} ${Zt})">
    <polygon
      points="${Zt},${38} ${97},${114} ${103},${114}"
      fill=${s}
    />
  </g>`}(r,e,i,a)}
      <circle cx=${Zt} cy=${Zt} r="6" class="hub" />
    </svg>
  `}const Qt=[(Xt="sensor",{name:"entity",selector:{entity:{domain:Xt}}}),St("name"),Pt("unit",[{value:"auto",label:"Auto-detect"},{value:"hPa",label:"hPa"},{value:"inHg",label:"inHg"}]),Ct("trend_hours",{min:1,max:12,step:1}),Ct("trend_threshold",{min:0,step:.1}),Pt("trend_text_size",wt),Pt("face_style",At),St("needle_color")];var Xt;const te=(ee={entity:"Pressure sensor entity",name:"Name (optional)",unit:"Display unit",trend_hours:"Trend lookback (hours)",trend_threshold:"Trend threshold",trend_text_size:"Trend text size",face_style:"Face style",needle_color:"Needle color (optional, overrides face style default)"},t=>ee[t.name]??t.name);var ee;let ie=class extends ct{setConfig(t){this._config=t}render(){return this.hass&&this._config?B`
      <ha-form
        .hass=${this.hass}
      ...
      ></ha-form>
    `:B``}_effectiveData(t,e){const i=e.entity?Gt(t,e.entity):"hPa",s=Kt(e.unit,i),r=e.face_style??Ht;return{...e,unit:e.unit??"auto",trend_hours:e.trend_hours??3,trend_threshold:e.trend_threshold??Jt(s),trend_text_size:e.trend_text_size??xt,face_style:r,needle_color:e.needle_color||Tt[r]}}_valueChanged(t){!function(t,e,i={},s={}){const r=new CustomEvent(e,{bubbles:s.bubbles??!0,cancelable:s.cancelable??!1,composed:s.composed??!0,detail:i});t.dispatchEvent(r)}(this,"config-changed",{config:t.detail.value})}};t([gt({attribute:!1})],ie.prototype,"hass",void 0),t([pt()],ie.prototype,"_config",void 0),ie=t([ut(Ot)],ie);const se={rising:"↑",falling:"↓",steady:"→",unknown:""},re={rising:"Rising",falling:"Falling",steady:"Steady",unknown:""};let ne=class extends ct{constructor(){super(...arguments),this._trendDirection="unknown",this._pastValueDisplay=null,this._tracker=new Mt("analog-barometer-card-trend-",Wt,3e5),this._lastEntityUpdate=null}setConfig(t){if(!t.entity)throw new Error("You must specify a pressure sensor entity.");this._config=t}getCardSize(){return 4}static getConfigElement(){return document.createElement(Ot)}static getStubConfig(t){const e=Object.values(t?.states??{}).find(t=>t.entity_id.startsWith("sensor.")&&"atmospheric_pressure"===t.attributes.device_class);return{type:"custom:analog-barometer-card",entity:e?.entity_id??""}}willUpdate(t){t.has("hass")&&this._maybeUpdateTrend()}_maybeUpdateTrend(){if(!this.hass||!this._config?.entity)return;const t=this.hass.states[this._config.entity];if(!t)return;const e=parseFloat(t.state);if(!Number.isFinite(e))return;const i=Gt(this.hass,this._config.entity),s=Kt(this._config.unit,i),r=Wt(e,i,s),n=this._config.trend_hours??3,a=this._config.trend_threshold??Jt(s);if(this._lastEntityUpdate===t.last_updated)return;this._lastEntityUpdate=t.last_updated;const o=this._tracker.update(this.hass,this._config.entity,r,i,s,n,a,t=>{this._trendDirection=t.direction,this._pastValueDisplay=t.pastValueDisplay});this._trendDirection=o?.direction??"unknown",this._pastValueDisplay=o?.pastValueDisplay??null}render(){if(!this._config||!this.hass)return B``;const t=this.hass.states[this._config.entity];if(!t)return B`<ha-card>
        <div class="warning">Entity not found: ${this._config.entity}</div>
      </ha-card>`;const e=Gt(this.hass,this._config.entity),i=Kt(this._config.unit,e),s=parseFloat(t.state),r=Number.isFinite(s),n=r?Wt(s,e,i):null,a="inHg"===i?{min:Vt(950),max:Vt(1050)}:{min:950,max:1050};const o=this._config.min??a.min,l=this._config.max??a.max,c=this._config.face_style??Ht,h=this._config.needle_color||Tt[c],u=this._config.name??t.attributes.friendly_name??this._config.entity,d=Et[this._config.trend_text_size??xt];return B`
      <ha-card>
        <div class=${$t({"card-content":!0,[`style-${c}`]:!0})}>
          <div class="title">${u}</div>
          ${Yt({min:o,max:l,unit:i,value:n,pastValue:this._pastValueDisplay,needleColor:h})}
          <div class="readout">
          ...
          <div class="trend trend-${this._trendDirection}" style="font-size: ${d}rem">
            <span class="arrow">${se[this._trendDirection]}</span>
            <span class="label">${re[this._trendDirection]}</span>
          </div>
        </div>
      </ha-card>
    `}};var ae;ne.styles=[Ut,a`
      :host {
        display: block;
      }
      .card-content {
    ...
    `],t([gt({attribute:!1})],ne.prototype,"hass",void 0),t([pt()],ne.prototype,"_config",void 0),t([pt()],ne.prototype,"_trendDirection",void 0),t([pt()],ne.prototype,"_pastValueDisplay",void 0),ne=t([ut(Dt)],ne),ae={type:Dt,name:"Analog Barometer",preview:!1,description:"A classic analog-style barometer with pressure trend tracking."},window.customCards=window.customCards||[],window.customCards.push(ae);export{ne as AnalogBarometerCard};
