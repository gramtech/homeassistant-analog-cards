 ...
 */
const e=globalThis,i=e.ShadowRoot&&(void 0===e.ShadyCSS||e.ShadyCSS.nativeShadow)&&"adoptedStyleSheets"in Document.prototype&&"replace"in CSSStyleSheet.prototype,s=Symbol(),r=new WeakMap;let n=class{constructor(t,e,i){if(this._$cssResult$=!0,i!==s)throw Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");this.cssText=t,this.t=e}get styleSheet(){let t=this.o;const e=this.t;if(i&&void 0===t){const i=void 0!==e&&1===e.length;i&&(t=r.get(e)),void 0===t&&((this.o=t=new CSSStyleSheet).replaceSync(this.cssText),i&&r.set(e,t))}return t}toString(){return this.cssText}};const a=(t,...e)=>{const i=1===t.length?t[0]:e.reduce((e,i,s)=>e+(t=>{if(!0===t._$cssResult$)return t.cssText;if("number"==typeof t)return t;throw Error("Value passed to 'css' function must be a 'css' function result: "+t+". Use 'unsafeCSS' to pass non-literal values, but take care to ensure page security.")})(i)+t[s+1],t[0]);return new n(i,t,s)},o=i?t=>t:t=>t instanceof CSSStyleSheet?(t=>{let e="";for(const i of t.cssRules)e+=i.cssText;return(t=>new n("string"==typeof t?t:t+"",void 0,s))(e)})(t):t,{is:l,defineProperty:c,getOwnPropertyDescriptor:h,getOwnPropertyNames:u,getOwnPropertySymbols:d,getPrototypeOf:f}=Object,g=globalThis,p=g.trustedTypes,b=p?p.emptyScript:"",_=g.reactiveElementPolyfillSupport,m=(t,e)=>t,$={toAttribute(t,e){switch(e){case Boolean:t=t?b:null;break;case Object:case Array:t=null==t?t:JSON.stringify(t)}return t},fromAttribute(t,e){let i=t;switch(e){case Boolean:i=null!==t;break;case Number:i=null===t?null:Number(t);break;case Object:case Array:try{i=JSON.parse(t)}catch(t){i=null}}return i}},y=(t,e)=>!l(t,e),k={attribute:!0,type:String,converter:$,reflect:!1,useDefault:!1,hasChanged:y};
/**
 * @license
 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const bt=1;class _t{constructor(t){}get _$AU(){return this._$AM._$AU}_$AT(t,e,i){this._$Ct=t,this._$AM=e,this._$Ci=i}_$AS(t,e){return this.update(t,e)}update(t,e){return this.render(...e)}}
/**
 * @license
 * Copyright 2018 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const mt=(t=>(...e)=>({_$litDirective$:t,values:e}))(class extends _t{constructor(t){if(super(t),t.type!==bt||"class"!==t.name||t.strings?.length>2)throw Error("`classMap()` can only be used in the `class` attribute and must be the only part in the attribute.")}render(t){return" "+Object.keys(t).filter(e=>t[e]).join(" ")+" "}update(t,[e]){if(void 0===this.st){this.st=new Set,void 0!==t.strings&&(this.nt=new Set(t.strings.join(" ").split(/\s/).filter(t=>""!==t)));for(const t in e)e[t]&&!this.nt?.has(t)&&this.st.add(t);return this.render(e)}const i=t.element.classList;for(const t of this.st)t in e||(i.remove(t),this.st.delete(t));for(const t in e){const s=!!e[t];s===this.st.has(t)||this.nt?.has(t)||(s?(i.add(t),this.st.add(t)):(i.remove(t),this.st.delete(t)))}return W}});function $t(t,e,i,s,r){if(i<=e)return s;return s+(Math.min(i,Math.max(e,t))-e)/(i-e)*(r-s)}function yt(t,e,i,s,r,n){return function(t,e,i,s){if(i<=0||s<=0||e<=t)return[];const r=[],n=s/1e3;for(let a=t;a<=e+n;a+=s){const t=Math.round(a/s)*s,e=Math.abs(t/i-Math.round(t/i))<n;r.push({value:t,major:e})}return r}(t,e,i,s).map(i=>({...i,position:$t(i.value,t,e,r,n)}))}const kt=[{value:"classic",label:"Classic"},{value:"silver",label:"Silver"},{value:"dark",label:"Dark"},{value:"light",label:"Light"},{value:"led-backlit",label:"LED Backlit"},{value:"fluorescent",label:"Fluorescent"},{value:"futuristic",label:"Futuristic"}],vt="large",At=[{value:"small",label:"Small"},{value:"medium",label:"Medium"},{value:"large",label:"Large"},{value:"x-large",label:"Extra large"}],wt={small:.8,medium:.9,large:1.05,"x-large":1.2};function xt(t){return{name:t,selector:{text:{}}}}function Et(t,e){return{name:t,selector:{number:{...e,mode:"box"}}}}function St(t,e){return{name:t,selector:{select:{mode:"dropdown",options:e}}}}function Ct(t,e,i){const s=t-e;return Math.abs(s)<i?"steady":s>0?"rising":"falling"}class Pt{constructor(t,e,i=3e5){this.storageKeyPrefix=t,this.convert=e,this.throttleMs=i,this.cache=null,this.cachedEntityId=null,this.inFlight=null}storageKey(t){return`${this.storageKeyPrefix}${t}`}getCached(t){return this.cachedEntityId!==t&&(this.cachedEntityId=t,this.cache=function(t){try{const e=localStorage.getItem(t);return e?JSON.parse(e):null}catch{return null}}(this.storageKey(t))),this.cache}shouldFetch(t){const e=this.getCached(t);return!e||Date.now()-e.fetchedAt>this.throttleMs}update(t,e,i,s,r,n,a,o){const l=this.getCached(e);return this.inFlight||!this.shouldFetch(e)||(this.inFlight=async function(t,e,i){const s=`history/period/${new Date(Date.now()-36e5*i).toISOString()}?filter_entity_id=${encodeURIComponent(e)}&minimal_response&no_attributes`,r=await t.callApi("GET",s),n=r?.[0];if(!n?.length)return null;const a=n[0],o=a.state??a.s;if(void 0===o)return null;const l=parseFloat(o);return Number.isFinite(l)?l:null}(t,e,n).then(t=>{if(null===t)return{direction:"unknown",pastValueDisplay:null,fetchedAt:Date.now()};const e=this.convert(t,s,r);return{direction:Ct(i,e,a),pastValueDisplay:e,fetchedAt:Date.now()}}).catch(()=>({direction:l?.direction??"unknown",pastValueDisplay:l?.pastValueDisplay??null,fetchedAt:Date.now()})).then(t=>(this.cache=t,function(t,e){try{localStorage.setItem(t,JSON.stringify(e))}catch{}}(this.storageKey(e),t),this.inFlight=null,o?.(t),t))),l}}a`
  .style-classic {
...
`,Ut="analog-thermometer-mercury-card",zt="analog-thermometer-mercury-card-editor",Dt="classic",Ot={classic:"#c0392b",silver:"#c9cdd1",dark:"#e05c4d",light:"#c0392b","led-backlit":"#ff4d4d",fluorescent:"#baff29",futuristic:"#ff2fd0"},Tt={"°C":{major:10,minor:2},"°F":{major:20,minor:5}},jt=60,Nt=20,Ht=168,Rt=10,qt=Ht-Math.sqrt(300),Ft="mercury-liquid-clip";function Lt(t,e){const i=jt-t,s=jt+t,r=Math.sqrt(e*e-t*t),n=Ht-r;return[`M ${i} 20`,`L ${i} ${n}`,`A ${e} ${e} 0 1 0 ${s} ${n}`,`L ${s} 20`,`A ${t} ${t} 0 1 0 ${i} 20`,"Z"].join(" ")}function It(t){const{min:e,max:i,unit:s,value:r,pastValue:n,liquidColor:a}=t;return B`
  ...
  `}</defs>
      ...
      ${function(t,e,i){const{major:s,minor:r}=Tt[i];return yt(t,e,s,r,qt,Nt).map(t=>{const e=t.major?8:4,i=B`<line
    ...
    />`;if(!t.major)return i;const s=B`<text x=${84} y=${t.position} class="tick-label" dominant-baseline="middle">${Math.round(10*t.value)/10}</text>`;return B`${i}${s}`})}(e,i,s)}
      ${function(t,e,i){if(null===t)return B``;const s=$t(t,e,i,qt,Nt);return B`<line
    x1=${42} y1=${s} x2=${48} y2=${s}
    class="trend-marker"
  />`}(n,e,i)}
      ${function(t,e,i,s){if(null===t)return B``;const r=$t(t,e,i,qt,Nt);return B`
    <defs>
      <clipPath id=${Ft}>
        <rect x="0" y=${r} width="140" height=${192-r} />
      </clipPath>
    </defs>
    <path d=${Lt(6,16)} class="liquid" fill=${s} clip-path=${`url(#${Ft})`} />
  `}(r,e,i,a)}
      <path d=${Lt(Rt,20)} class="glass" />
      <line
        x1=${53} y1=${26}
        x2=${53} y2=${qt-6}
  ...
  `}function Vt(t){return 9*t/5+32}function Bt(t,e,i){return e===i?t:(s=function(t,e){return"°F"===e?function(t){return 5*(t-32)/9}(t):t}(t,e),"°F"===i?Vt(s):s);var s}function Wt(t,e){return t&&"auto"!==t?t:e}function Kt(t,e){const i=t.states[e]?.attributes?.unit_of_measurement;return i&&i.toLowerCase().includes("f")?"°F":"°C"}function Gt(t){return"°F"===t?1.8:1}const Jt=[(Zt="sensor",{name:"entity",selector:{entity:{domain:Zt}}}),xt("name"),St("unit",[{value:"auto",label:"Auto-detect"},{value:"°C",label:"°C"},{value:"°F",label:"°F"}]),Et("trend_hours",{min:1,max:12,step:1}),Et("trend_threshold",{min:0,step:.1}),St("trend_text_size",At),St("face_style",kt),xt("liquid_color")];var Zt;const Yt=(Qt={entity:"Temperature sensor entity",name:"Name (optional)",unit:"Display unit",trend_hours:"Trend lookback (hours)",trend_threshold:"Trend threshold",trend_text_size:"Trend text size",face_style:"Face style",liquid_color:"Liquid color (optional, overrides face style default)"},t=>Qt[t.name]??t.name);var Qt;let Xt=class extends ct{setConfig(t){this._config=t}render(){return this.hass&&this._config?V`
      <ha-form
        .hass=${this.hass}
      ...
      ></ha-form>
    `:V``}_effectiveData(t,e){const i=e.entity?Kt(t,e.entity):"°C",s=Wt(e.unit,i),r=e.face_style??Dt;return{...e,unit:e.unit??"auto",trend_hours:e.trend_hours??3,trend_threshold:e.trend_threshold??Gt(s),trend_text_size:e.trend_text_size??vt,face_style:r,liquid_color:e.liquid_color||Ot[r]}}_valueChanged(t){!function(t,e,i={},s={}){const r=new CustomEvent(e,{bubbles:s.bubbles??!0,cancelable:s.cancelable??!1,composed:s.composed??!0,detail:i});t.dispatchEvent(r)}(this,"config-changed",{config:t.detail.value})}};t([gt({attribute:!1})],Xt.prototype,"hass",void 0),t([pt()],Xt.prototype,"_config",void 0),Xt=t([ut(zt)],Xt);const te={rising:"↑",falling:"↓",steady:"→",unknown:""},ee={rising:"Rising",falling:"Falling",steady:"Steady",unknown:""};let ie=class extends ct{constructor(){super(...arguments),this._trendDirection="unknown",this._pastValueDisplay=null,this._tracker=new Pt("analog-thermometer-mercury-card-trend-",Bt,3e5),this._lastEntityUpdate=null}setConfig(t){if(!t.entity)throw new Error("You must specify a temperature sensor entity.");this._config=t}getCardSize(){return 4}static getConfigElement(){return document.createElement(zt)}static getStubConfig(t){const e=Object.values(t?.states??{}).find(t=>t.entity_id.startsWith("sensor.")&&"temperature"===t.attributes.device_class);return{type:"custom:analog-thermometer-mercury-card",entity:e?.entity_id??""}}willUpdate(t){t.has("hass")&&this._maybeUpdateTrend()}_maybeUpdateTrend(){if(!this.hass||!this._config?.entity)return;const t=this.hass.states[this._config.entity];if(!t)return;const e=parseFloat(t.state);if(!Number.isFinite(e))return;const i=Kt(this.hass,this._config.entity),s=Wt(this._config.unit,i),r=Bt(e,i,s),n=this._config.trend_hours??3,a=this._config.trend_threshold??Gt(s);if(this._lastEntityUpdate===t.last_updated)return;this._lastEntityUpdate=t.last_updated;const o=this._tracker.update(this.hass,this._config.entity,r,i,s,n,a,t=>{this._trendDirection=t.direction,this._pastValueDisplay=t.pastValueDisplay});this._trendDirection=o?.direction??"unknown",this._pastValueDisplay=o?.pastValueDisplay??null}render(){if(!this._config||!this.hass)return V``;const t=this.hass.states[this._config.entity];if(!t)return V`<ha-card>
        <div class="warning">Entity not found: ${this._config.entity}</div>
      </ha-card>`;const e=Kt(this.hass,this._config.entity),i=Wt(this._config.unit,e),s=parseFloat(t.state),r=Number.isFinite(s),n=r?Bt(s,e,i):null,a="°F"===i?{min:Vt(-20),max:Vt(45)}:{min:-20,max:45};const o=this._config.min??a.min,l=this._config.max??a.max,c=this._config.face_style??Dt,h=this._config.liquid_color||Ot[c],u=this._config.name??t.attributes.friendly_name??this._config.entity,d=wt[this._config.trend_text_size??vt];return V`
      <ha-card>
        <div class=${mt({"card-content":!0,[`style-${c}`]:!0})}>
          <div class="title">${u}</div>
          ${It({min:o,max:l,unit:i,value:n,pastValue:this._pastValueDisplay,liquidColor:h})}
          <div class="readout">
          ...
          <div class="trend trend-${this._trendDirection}" style="font-size: ${d}rem">
            <span class="arrow">${te[this._trendDirection]}</span>
            <span class="label">${ee[this._trendDirection]}</span>
          </div>
        </div>
      </ha-card>
    `}};var se;ie.styles=[Mt,a`
      :host {
        display: block;
      }
      .card-content {
    ...
    `],t([gt({attribute:!1})],ie.prototype,"hass",void 0),t([pt()],ie.prototype,"_config",void 0),t([pt()],ie.prototype,"_trendDirection",void 0),t([pt()],ie.prototype,"_pastValueDisplay",void 0),ie=t([ut(Ut)],ie),se={type:Ut,name:"Analog Thermometer (Mercury)",preview:!1,description:"A classic mercury-tube style thermometer with temperature trend tracking."},window.customCards=window.customCards||[],window.customCards.push(se);export{ie as AnalogThermometerMercuryCard};
